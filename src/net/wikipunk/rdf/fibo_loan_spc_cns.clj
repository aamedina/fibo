(ns net.wikipunk.rdf.fibo-loan-spc-cns
  ...
  {:dcat/downloadURL
   ...
   :sm/fileAbbreviation "fibo-loan-spc-cns"})
...
(def HomeEquityLineOfCredit
  ...
  {:db/ident :fibo-loan-spc-cns/HomeEquityLineOfCredit,
   ...
   [{:rdf/language "en",
     :rdf/value
     "This is both a revolving line of credit and a mortgage, in that the collateral for the revolving line of credit in this case is some real estate, which is a defining fact for a mortgage. This form of product can either have an increase or decrease in principal, according to the actions of the borrower. These may also be used in the formation of asset pools for asset backed securities."}
    {:rdf/language "en",
     :rdf/value
