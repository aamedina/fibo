...
(def CommonShare
  ...
  {:db/ident :fibo-sec-eq-eq/CommonShare,
   ...
   :rdfs/subClassOf [{:owl/minQualifiedCardinality 0,
                      ...
                      :owl/onProperty :fibo-sec-eq-eq/pays,
                      :rdf/type       :owl/Restriction}
...
(def LimitedPartnershipUnit
  ...
  {:db/ident :fibo-sec-eq-eq/LimitedPartnershipUnit,
   ...
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-agr-ctr/hasCounterparty,
                     ...
                     :fibo-sec-eq-eq/Share],
   :skos/definition {:rdf/language "en",
                     :rdf/value    "share in a limited partnership"}})
...
(def ListedShare
  ...
  {:db/ident :fibo-sec-eq-eq/ListedShare,
   ...
   :rdfs/subClassOf [:fibo-sec-sec-lst/ListedSecurity :fibo-sec-eq-eq/Share],
   :skos/definition {:rdf/language "en",
                     :rdf/value
                     "share that is listed on at least one platform"}})
...
(def PreferredShare
  ...
  {:db/ident :fibo-sec-eq-eq/PreferredShare,
   ...
   :rdfs/subClassOf [{:owl/onProperty     :fibo-sec-eq-eq/isSeniorTo,
...
(def RedeemablePreferredShare
  ...
  {:db/ident :fibo-sec-eq-eq/RedeemablePreferredShare,
   ...
   :rdfs/subClassOf [{:owl/onProperty :fibo-fbc-fi-fi/hasRedemptionProvision,
                      :owl/someValuesFrom
                      :fibo-sec-eq-eq/EquityRedemptionProvision,
                      :rdf/type :owl/Restriction}
                     :fibo-sec-eq-eq/PreferredShare],
...
(def RestrictedVotingShare
  ...
  {:db/ident :fibo-sec-eq-eq/RestrictedVotingShare,
   ...
   [{:owl/onProperty     :fibo-sec-eq-eq/confersNumberOfVotesPerShare,
     :owl/someValuesFrom {:owl/onDatatype :xsd/decimal,
                          :owl/withRestrictions [{:xsd/maxExclusive 1}],
                          :rdf/type       :rdfs/Datatype},
     :rdf/type           :owl/Restriction}
    :fibo-sec-eq-eq/Share],
   :skos/definition {:rdf/language "en",
...
(def hasDividend
  "relates a share to a dividend that applies to that share"
  {:db/ident :fibo-sec-eq-eq/hasDividend,
   ...
   :rdfs/range {:owl/unionOf [:fibo-sec-eq-eq/OrdinaryDividend
                              :fibo-sec-eq-eq/PreferredDividend],
                :rdf/type    :owl/Class},
   :rdfs/subPropertyOf :lcc-lr/has,
   :skos/definition "relates a share to a dividend that applies to that share"})
...
(def pays
  "relates a share to a dividend that it may pay to shareholders"
