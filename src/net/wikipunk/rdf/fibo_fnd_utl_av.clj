...
(def MaturityLevel
  "classifier used to indicate state of an artifact with respect to its development lifecycle"
...
(def abbreviation
  "short form designation for an entity that can be substituted for its primary representation"
...
(def adaptedFrom
  "document or other source from which a given term (or its definition) was adapted; the range for this annotation can be a string, URI, or BibliographicCitation"
...
(def explanatoryNote
  "note that provides additional explanatory information about a given concept"
...
(def logicalDefinition
  "description of the OWL logic of a model element in natural language"
...
(def modifiedBy
  "organization or person responsible for making a change to a model element"
...
(def modifiedOn
  "date a model element was changed"
...
(def symbol
  "abbreviation that is a design, mark, or character(s) used conventionally to represent something, such as a currency, quantity, or variable in an expression"
  {:db/ident :fibo-fnd-utl-av/symbol,
   :fibo-fnd-utl-av/adaptedFrom
   "ISO 31-0 Quantities and units - General principles",
   :fibo-fnd-utl-av/explanatoryNote
   "The symbols for quantities are generally single letters of the Latin or Greek alphabet, sometimes with subscripts or other modifying signs.",
   :rdf/type :owl/AnnotationProperty,
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/FND/Utilities/AnnotationVocabulary/",
   :rdfs/label "symbol",
...
(def usageNote
  "note that provides information about how a given concept should be used or extended"
