...
(def Catalog
  ...
  {:db/ident :fibo-fbc-pas-fpas/Catalog,
   ...
   "https://spec.edmcouncil.org/fibo/ontology/FBC/ProductsAndServices/FinancialProductsAndServices/",
   :rdfs/label "catalog",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-rel-rel/describes,
...
(def Trade
  ...
  {:db/ident :fibo-fbc-pas-fpas/Trade,
   ...
   "https://spec.edmcouncil.org/fibo/ontology/FBC/ProductsAndServices/FinancialProductsAndServices/",
   :rdfs/label "trade",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-pas-fpas/isEmbodiedIn,
...
(def precedes
  "relates a product, organization, stage in a lifecycle, an event, or occurrence, such as a trade, to one that occurs before it"
...
(def succeeds
  ...
  {:db/ident :fibo-fbc-pas-fpas/succeeds,
   :owl/inverseOf :fibo-fbc-pas-fpas/precedes,
   :rdf/type :owl/ObjectProperty,
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/FBC/ProductsAndServices/FinancialProductsAndServices/",
   :rdfs/label "succeeds",
