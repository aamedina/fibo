...
(def PhysicalAddress
  ...
  {:cmns-av/usageNote
   ...
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-plc-loc/hasSubdivision,
...
(def RegionSpecificIdentifier
  ...
  {:db/ident :fibo-fnd-plc-adr/RegionSpecificIdentifier,
   ...
   :rdfs/subClassOf [{:owl/onProperty     :lcc-cr/isUsedBy,
...
(def StructureName
  "identifier for a building, house, office complex, shopping center, or other structure or group of structures"
