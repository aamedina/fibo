(ns net.wikipunk.rdf.lcc-cr
  ...
  {:dcterms/license {:xsd/anyURI "http://opensource.org/licenses/MIT"},
   ...
   :xsd/anyURI "https://www.omg.org/spec/LCC/Countries/CountryRepresentation/"})
...
(def CoordinateSystem
  {:db/ident :lcc-cr/CoordinateSystem,
   :dcterms/source
   #{{:xsd/anyURI "https://en.wikipedia.org/wiki/Coordinate_system"}
     {:xsd/anyURI
...
(def GeographicCoordinateSystem
  {:db/ident :lcc-cr/GeographicCoordinateSystem,
   ...
   #{{:xsd/anyURI
      "http://edndoc.esri.com/arcsde/9.1/general_topics/what_coord_sys.htm"}
     {:xsd/anyURI "https://pubs.usgs.gov/circ/1983/0878b/report.pdf"}},
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:xsd/anyURI
    "https://www.omg.org/spec/LCC/Countries/CountryRepresentation/"},
...
(def hasLatitude
  {:db/ident :lcc-cr/hasLatitude,
   ...
   :rdfs/range {:owl/onDatatype :xsd/decimal,
                :owl/withRestrictions [{:xsd/maxInclusive 90M}
                                       {:xsd/minInclusive -90M}],
...
(def hasLongitude
  {:db/ident :lcc-cr/hasLongitude,
   ...
   :rdfs/range {:owl/onDatatype :xsd/decimal,
                :owl/withRestrictions [{:xsd/maxInclusive 180M}
                                       {:xsd/minInclusive -180M}],
                :rdf/type       :rdfs/Datatype},
   :skos/definition
...
(def urn:uuid:1ac0b3b4-c064-5292-ad9b-018b8ef2e2cf
  {:dcterms/license {:xsd/anyURI "http://opensource.org/licenses/MIT"},
   :owl/imports
   {:xsd/anyURI
    "https://www.omg.org/spec/LCC/Languages/LanguageRepresentation/"},
