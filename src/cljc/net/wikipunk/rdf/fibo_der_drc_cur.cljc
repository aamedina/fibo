(ns net.wikipunk.rdf.fibo-der-drc-cur
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 Object Management Group, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/",
   :rdfs/label #xsd/langString "Currency Contracts Ontology@en",
   :skos/changeNote
...
(def CurrencyDerivative
  ...
  {:cmns-av/abbreviation #xsd/langString "FX derivative@en",
   :cmns-av/synonym [#xsd/langString "forex derivative@en"
                     #xsd/langString "foreign exchange derivative@en"],
   :db/ident :fibo-der-drc-cur/CurrencyDerivative,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency derivative@en",
...
(def CurrencyForward
  ...
  {:cmns-av/synonym [#xsd/langString "foreign exchange forward@en"
                     #xsd/langString "FX forward@en"],
   :db/ident :fibo-der-drc-cur/CurrencyForward,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency forward@en",
...
(def CurrencyForwardOutright
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym [#xsd/langString "forward outright@en"
                     #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency forward outright@en",
   :rdfs/subClassOf
...
(def CurrencyOption
  ...
  {:cmns-av/abbreviation #xsd/langString "FX option@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   :cmns-av/synonym [#xsd/langString "forex option@en"
                     #xsd/langString "foreign exchange option@en"],
   :db/ident :fibo-der-drc-cur/CurrencyOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency option@en",
...
(def CurrencySpotContract
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "foreign exchange spot contract@en",
   :db/ident :fibo-der-drc-cur/CurrencySpotContract,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency spot contract@en",
...
(def CurrencySpotForwardSwap
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency spot forward swap@en",
   :rdfs/subClassOf
...
(def CurrencySwap
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency swap@en",
...
(def CurrencyVolatilityOption
  ...
  {:db/ident :fibo-der-drc-cur/CurrencyVolatilityOption,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "currency volatility option@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def hasBuyingCurrency
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "has buying currency@en",
...
(def hasForwardExchangeRate
  ...
  {:db/ident :fibo-der-drc-cur/hasForwardExchangeRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "has forward exchange rate@en",
...
(def hasSellingCurrency
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "has selling currency@en",
   :rdfs/range :fibo-fnd-acc-cur/Currency,
...
(def hasSpotExchangeRate
  ...
  {:db/ident :fibo-der-drc-cur/hasSpotExchangeRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/CurrencyContracts/"},
   :rdfs/label #xsd/langString "has spot exchange rate@en",
   :rdfs/range :fibo-fnd-acc-cur/ExchangeRate,
   :rdfs/subPropertyOf :fibo-fnd-qt-qtu/hasQuantityValue,
   :skos/definition
   #xsd/langString
