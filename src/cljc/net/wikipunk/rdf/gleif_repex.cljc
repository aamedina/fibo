(ns net.wikipunk.rdf.gleif-repex
  ...
  {:dcat/downloadURL
   ...
   :owl/imports [{:rdfa/uri "https://www.gleif.org/ontology/L1/"}
...
(def DirectConsolidationReportingException
  "direct consolidation reporting exception"
...
(def UltimateConsolidationReportingException
  "ultimate consolidation reporting exception"
