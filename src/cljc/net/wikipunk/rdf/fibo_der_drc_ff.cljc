(ns net.wikipunk.rdf.fibo-der-drc-ff
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 EDM Council, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/",
   :rdfs/label #xsd/langString "Futures and Forwards Ontology@en",
   :skos/changeNote
...
(def BasketFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "basket future@en",
...
(def BondFuture
  ...
  {:db/ident :fibo-der-drc-ff/BondFuture,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "bond future@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
   ...
   :skos/definition
   #xsd/langString
    "futures contract whose underlying asset is at least one bond@en"})
...
(def CurrencyFuture
  ...
  {:cmns-av/adaptedFrom
   #xsd/langString
    "ISO 10962, Securities and related financial instruments - Classification of financial instruments (CFI) code, Fourth Edition, October 2019@en",
   :cmns-av/synonym [#xsd/langString "forex future@en"
                     #xsd/langString "foreign exchange future@en"],
   :db/ident :fibo-der-drc-ff/CurrencyFuture,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "currency future@en",
...
(def DebtInstrumentFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "debt instrument future@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom :fibo-fbc-fi-fi/DebtInstrument,
                      :rdf/type           :owl/Restriction}
                     :fibo-der-sbd-sbd/DebtInstrumentDerivative
...
(def DividendAdjustmentPeriod
  ...
  {:db/ident :fibo-der-drc-ff/DividendAdjustmentPeriod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "dividend adjustment period@en",
...
(def DividendFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "dividend future@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def EquityForward
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "equity forward@en",
   :rdfs/subClassOf
...
(def EquityFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "equity future@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom :fibo-sec-eq-eq/ListedShare,
                      :rdf/type           :owl/Restriction}
                     :fibo-der-sbd-sbd/EquityDerivative
...
(def FinancialFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "financial future@en",
...
(def Forward
  ...
  {:cmns-av/adaptedFrom
   ...
   :cmns-av/synonym #xsd/langString "forward contract@en",
...
(def ForwardContractAdjustmentMethod
  ...
  {:db/ident :fibo-der-drc-ff/ForwardContractAdjustmentMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "forward contract adjustment method@en",
...
(def FutureOnFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "future on future@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def FutureOnOption
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "future on option@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def FutureOnSwap
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "future on swap@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def IndexFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "index future@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def InterestRateFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "interest rate future@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom
...
(def MoneyMarketFuture
  ...
  {:db/ident :fibo-der-drc-ff/MoneyMarketFuture,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "money market future@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom
...
(def StandardizedFuturesListingTerms
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "standardized futures listing terms@en",
...
(def StandardizedFuturesTerms
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "standardized futures terms@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cxtdsg/appliesTo,
                      :owl/someValuesFrom :fibo-fbc-fi-fi/Future,
                      :rdf/type           :owl/Restriction}
...
(def hasConversionFactor
  ...
  {:db/ident :fibo-der-drc-ff/hasConversionFactor,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "has conversion factor@en",
...
(def hasDividendAdjustmentPeriod
  ...
  {:db/ident :fibo-der-drc-ff/hasDividendAdjustmentPeriod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "has dividend adjustment period@en",
...
(def hasMethodOfAdjustment
  ...
  {:db/ident :fibo-der-drc-ff/hasMethodOfAdjustment,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "has method of adjustment@en",
...
(def hasMultiple
  ...
  {:db/ident :fibo-der-drc-ff/hasMultiple,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/FuturesAndForwards/"},
   :rdfs/label #xsd/langString "has multiple@en",
   :rdfs/range :xsd/decimal,
   :rdfs/subPropertyOf :fibo-fnd-qt-qtu/hasNumericValue,
   :skos/definition
   #xsd/langString
