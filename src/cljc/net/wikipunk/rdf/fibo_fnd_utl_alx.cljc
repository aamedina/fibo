(ns net.wikipunk.rdf.fibo-fnd-utl-alx
  ^{:base "https://spec.edmcouncil.org/fibo/ontology/FND/Utilities/Analytics/",
    :namespaces
...
(def Mean
  {:cmns-av/adaptedFrom
   #{{:xsd/anyURI "https://stats.oecd.org/glossary/detail.asp?ID=3762"}
     {:xsd/anyURI
   ...
   :cmns-av/symbol "μ",
   :cmns-av/synonym #{"first (raw) moment" "expected value"},
...
(def SamplingVariance
  {:cmns-av/adaptedFrom
   #{{:xsd/anyURI
     ...
     {:xsd/anyURI "https://stats.oecd.org/glossary/detail.asp?ID=3834"}},
   :cmns-av/explanatoryNote
...
(def ScopedMeasure
  {:cmns-av/explanatoryNote
   ...
   :rdfs/subClassOf #{{:owl/allValuesFrom :fibo-fnd-dt-fd/RecurrenceInterval,
...
(def StandardDeviation
  {:cmns-av/abbreviation "SD",
   ...
   #{{:xsd/anyURI
     ...
     {:xsd/anyURI "https://stats.oecd.org/glossary/detail.asp?ID=3845"}},
   :cmns-av/explanatoryNote
...
(def StatisticalArea
  {:cmns-av/adaptedFrom
   ...
   :rdfs/subClassOf #{{:owl/onProperty :cmns-id/isIdentifiedBy,
                       ...
                       :rdf/type :owl/Restriction} :lcc-cr/GeographicRegion},
   :skos/definition
...
(def StatisticalPopulation
  {:cmns-av/adaptedFrom {:xsd/anyURI
   ...
   :rdfs/subClassOf #{:fibo-fnd-utl-alx/FinitePopulation
...
(def StatisticalProgram
  {:db/ident :fibo-fnd-utl-alx/StatisticalProgram,
   ...
   :rdfs/subClassOf #{:fibo-fnd-gao-obj/Program
