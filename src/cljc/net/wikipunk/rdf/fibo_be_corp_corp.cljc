...
(def PrivatelyHeldCompany
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym ["privately held corporation" "closed corporation"],
...
(def PubliclyHeldCompany
  "corporation whose shares are traded and held publicly"
...
(def hasIssuedCapital
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym ["has subscribed share capital" "has subscribed capital"],
...
(def hasSharesAuthorized
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/Corporations/Corporations/"},
   :rdfs/label #xsd/langString "has shares authorized@en",
