(ns net.wikipunk.rdf.fibo-loan-ln-ev
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 Object Management Group, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/",
   :rdfs/label #xsd/langString "LoanEvents@en"})
...
(def CollateralValuation
  ...
  {:db/ident :fibo-loan-ln-ev/CollateralValuation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "collateral valuation@en",
...
(def CourtJudgment
  ...
  {:db/ident :fibo-loan-ln-ev/CourtJudgment,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "court judgment@en",
...
(def LegalProceeding
  ...
  {:db/ident :fibo-loan-ln-ev/LegalProceeding,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "legal proceeding@en",
...
(def LoanDefaultProceeding
  ...
  {:db/ident :fibo-loan-ln-ev/LoanDefaultProceeding,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "loan default proceeding@en",
...
(def LoanPaidInFull
  ...
  {:db/ident :fibo-loan-ln-ev/LoanPaidInFull,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "loan paid in full@en",
...
(def LoanPhase
  ...
  {:db/ident :fibo-loan-ln-ev/LoanPhase,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "loan phase@en",
...
(def Prepayment
  ...
  {:db/ident :fibo-loan-ln-ev/Prepayment,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "prepayment@en",
...
(def RepaymentPhase
  ...
  {:db/ident :fibo-loan-ln-ev/RepaymentPhase,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "repayment phase@en",
   :rdfs/subClassOf [:fibo-loan-ln-ev/LoanPhase
                     :fibo-fnd-arr-lif/LifecycleStage]})
...
(def hasDefaultAmount
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "has default amount@en",
...
(def hasDisbursementDate
  ...
  {:db/ident :fibo-loan-ln-ev/hasDisbursementDate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "disbursement date@en",
...
(def hasJudgementAmount
  ...
  {:db/ident :fibo-loan-ln-ev/hasJudgementAmount,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "has judgement amount@en",
   :rdfs/range :fibo-fnd-acc-cur/MonetaryAmount,
   :rdfs/subPropertyOf :fibo-fnd-acc-cur/hasMonetaryAmount,
   :skos/definition
   #xsd/langString
...
(def inDefault
  ...
  {:db/ident :fibo-loan-ln-ev/inDefault,
   ...
   :skos/definition #xsd/langString "Whether the loan is in default.@en"})
...
(def isAgainst
  ...
  {:db/ident :fibo-loan-ln-ev/isAgainst,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "is against@en",
...
(def isDeferred
  ...
  {:db/ident :fibo-loan-ln-ev/isDeferred,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "is deferred@en",
   :rdfs/range :xsd/boolean})
...
(def isDeliveredBy
  ...
  {:db/ident :fibo-loan-ln-ev/isDeliveredBy,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/LoansGeneral/LoanEvents/"},
   :rdfs/label #xsd/langString "is delivered by@en",
