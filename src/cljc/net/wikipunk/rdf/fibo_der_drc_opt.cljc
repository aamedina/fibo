(ns net.wikipunk.rdf.fibo-der-drc-opt
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 EDM Council, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/",
   :rdfs/label #xsd/langString "Options Ontology@en",
   :skos/changeNote
...
(def AtTheMoney
  ...
  {:cmns-av/abbreviation #xsd/langString "ATM@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "at-the-money@en",
   :skos/definition
   #xsd/langString
...
(def BasketOption
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "basket option@en",
   :rdfs/subClassOf
...
(def BondOption
  ...
  {:db/ident :fibo-der-drc-opt/BondOption,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "bond option@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def Butterfly
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "butterfly@en",
   :rdfs/subClassOf [{:owl/onClass    :fibo-fbc-fi-fi/Option,
                      :owl/onProperty :cmns-col/comprises,
                      :owl/qualifiedCardinality #xsd/nonNegativeInteger 4,
                      :rdf/type       :owl/Restriction}
                     {:owl/onClass    :fibo-der-drc-opt/StrikePrice,
                      :owl/onProperty :fibo-der-drc-opt/hasExercisePrice,
                      :owl/qualifiedCardinality #xsd/nonNegativeInteger 3,
                      :rdf/type       :owl/Restriction}
...
(def CallOption
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "call option@en",
...
(def CappedOption
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "capped option@en",
   :rdfs/subClassOf
...
(def Collar
  ...
  {:db/ident :fibo-der-drc-opt/Collar,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "collar@en",
...
(def CondorSpread
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "condor spread@en",
...
(def CoveredCall
  ...
  {:db/ident :fibo-der-drc-opt/CoveredCall,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "covered call@en",
...
(def EquityOption
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "equity option@en",
   :rdfs/subClassOf
...
(def ExoticOption
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "exotic option@en",
   :rdfs/subClassOf [:fibo-fbc-fi-fi/Option
                     :fibo-der-drc-bsc/OverTheCounterInstrument
                     {:owl/onProperty     :fibo-der-drc-opt/hasOptionWriter,
                      :owl/someValuesFrom :fibo-der-drc-opt/OptionIssuer,
...
(def ExtrinsicValue
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "option time value@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "extrinsic value@en",
...
(def Fence
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "fence@en",
   :rdfs/subClassOf [{:owl/onClass    :fibo-der-drc-opt/PutOption,
                      :owl/onProperty :cmns-col/comprises,
...
(def FixedIncomeOption
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "fixed income option@en",
   :rdfs/subClassOf
   [:fibo-der-sbd-sbd/DebtInstrumentDerivative
    :fibo-der-drc-opt/VanillaOption
    {:owl/onProperty     :fibo-der-drc-opt/hasOptionWriter,
...
(def InTheMoney
  ...
  {:cmns-av/abbreviation #xsd/langString "ITM@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "in-the-money@en",
   :skos/definition
   #xsd/langString
...
(def InterestRateOption
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "interest rate option@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def IntrinsicValue
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "intrinsic value@en",
   :rdfs/subClassOf :fibo-fnd-acc-cur/MonetaryAmount,
   :skos/definition
   #xsd/langString
...
(def IronButterfly
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "iron fly@en",
   :db/ident :fibo-der-drc-opt/IronButterfly,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "iron butterfly@en",
   :rdfs/subClassOf [{:owl/onClass    :fibo-der-drc-opt/PutOption,
                      :owl/onProperty :cmns-col/comprises,
                      :owl/qualifiedCardinality #xsd/nonNegativeInteger 2,
                      :rdf/type       :owl/Restriction}
...
(def IronCondor
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "iron condor@en",
...
(def LongTermEquityAnticipationSecurity
  ...
  {:cmns-av/abbreviation #xsd/langString "LEAP@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "long-term equity anticipation security@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-fnd-agr-ctr/hasContractDuration,
...
(def Moneyness
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "moneyness@en",
...
(def OptionHolder
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "option holder@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-rel-rel/holds,
                      :owl/someValuesFrom :fibo-fbc-fi-fi/Option,
                      :rdf/type           :owl/Restriction}
                     :fibo-fnd-oac-own/Owner],
   :skos/definition #xsd/langString "party that owns an option@en"})
...
(def OptionIssuer
  ...
  {:db/ident :fibo-der-drc-opt/OptionIssuer,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "option issuer@en",
   :rdfs/subClassOf
...
(def OptionOnFuture
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "option on future@en",
   :rdfs/subClassOf
...
(def OptionPremium
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "option premium@en",
   ...
   :skos/definition #xsd/langString
                     "current market price of an option contract@en"})
...
(def OptionPremiumFormula
  ...
  {:db/ident :fibo-der-drc-opt/OptionPremiumFormula,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "option premium formula@en",
...
(def OptionTradingStrategy
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "option trading strategy@en",
...
(def OutOfTheMoney
  ...
  {:cmns-av/abbreviation #xsd/langString "OTM@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "out-of-the-money@en",
   :skos/definition
   #xsd/langString
...
(def ProtectiveCollar
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "protective collar@en",
   ...
   :skos/definition
   #xsd/langString
    "collar that consists of a covered call and protective put@en"})
...
(def ProtectivePut
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "synthetic call@en",
   :db/ident :fibo-der-drc-opt/ProtectivePut,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "protective put@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-der-drc-opt/hasCalculatedMarketValue,
...
(def PutOption
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "put option@en",
   :rdfs/subClassOf [:fibo-fbc-fi-fi/Option
                     {:owl/onProperty     :fibo-der-drc-opt/hasOptionWriter,
                      :owl/someValuesFrom :fibo-der-drc-opt/OptionIssuer,
                      :rdf/type           :owl/Restriction}
...
(def RiskReversal
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "risk reversal@en",
   :rdfs/subClassOf [{:owl/onClass    :fibo-der-drc-opt/PutOption,
                      :owl/onProperty :cmns-col/comprises,
                      :owl/qualifiedCardinality #xsd/nonNegativeInteger 1,
                      :rdf/type       :owl/Restriction}
...
(def StandardizedOptionsTerms
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "standardized options terms@en",
   :rdfs/subClassOf
...
(def Straddle
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "straddle@en",
   :rdfs/subClassOf [{:owl/onClass    :fibo-der-drc-opt/PutOption,
                      :owl/onProperty :cmns-col/comprises,
                      :owl/qualifiedCardinality #xsd/nonNegativeInteger 1,
                      :rdf/type       :owl/Restriction}
...
(def Strangle
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "strangle@en",
   :rdfs/subClassOf [{:owl/onClass    :fibo-der-drc-opt/PutOption,
                      :owl/onProperty :cmns-col/comprises,
                      :owl/qualifiedCardinality #xsd/nonNegativeInteger 1,
                      :rdf/type       :owl/Restriction}
...
(def StrikePrice
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "strike price@en",
...
(def StripStrategy
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "strip strategy@en",
...
(def VanillaOption
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "vanilla option@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-fnd-agr-ctr/hasContractDuration,
     :owl/someValuesFrom :cmns-dt/ExplicitDuration,
     :rdf/type           :owl/Restriction}
...
(def hasCalculatedMarketValue
  ...
  {:cmns-av/synonym #xsd/langString "has premium@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has calculated market value@en",
...
(def hasCapPrice
  ...
  {:db/ident :fibo-der-drc-opt/hasCapPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has cap price@en",
...
(def hasExerciseDateOffset
  ...
  {:db/ident :fibo-der-drc-opt/hasExerciseDateOffset,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has exercise date offset@en",
...
(def hasExercisePrice
  ...
  {:cmns-av/synonym #xsd/langString "has strike price@en",
   :db/ident :fibo-der-drc-opt/hasExercisePrice,
   :rdf/type :owl/ObjectProperty,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has exercise price@en",
...
(def hasExerciseSchedule
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has exercise schedule@en",
...
(def hasInterestAccrualDateOffset
  ...
  {:db/ident :fibo-der-drc-opt/hasInterestAccrualDateOffset,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has interest accrual date offset@en",
   :rdfs/range :cmns-dt/Duration,
   :rdfs/subPropertyOf :cmns-dt/hasDuration,
   :skos/definition
   #xsd/langString
...
(def hasSettlementDateOffset
  ...
  {:db/ident :fibo-der-drc-opt/hasSettlementDateOffset,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has settlement date offset@en",
   :rdfs/range :cmns-dt/Duration,
   :rdfs/subPropertyOf :cmns-dt/hasDuration,
   :skos/definition
   #xsd/langString
...
(def hasStrikePercentageAmount
  ...
  {:db/ident :fibo-der-drc-opt/hasStrikePercentageAmount,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has strike percentage amount@en",
...
(def hasStrikeRate
  ...
  {:db/ident :fibo-der-drc-opt/hasStrikeRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/Options/"},
   :rdfs/label #xsd/langString "has strike rate@en",
   :rdfs/range :fibo-fnd-utl-alx/RatioValue,
   :rdfs/subPropertyOf :fibo-fnd-qt-qtu/hasQuantityValue,
   :skos/definition #xsd/langString
                     "rate at which the contract may be exercised@en"})