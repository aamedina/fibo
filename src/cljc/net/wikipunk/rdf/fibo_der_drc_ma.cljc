(ns net.wikipunk.rdf.fibo-der-drc-ma
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 EDM Council, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/",
   :rdfs/label #xsd/langString "Derivatives Master Agreements Ontology@en"})
...
(def CreditEventDefinition
  ...
  {:db/ident :fibo-der-drc-ma/CreditEventDefinition,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "credit event definition@en",
   ...
   :skos/definition
   #xsd/langString
    "contract definition for a credit event as it pertains to the master agreement@en"})
...
(def CreditSupportAgreement
  ...
  {:db/ident :fibo-der-drc-ma/CreditSupportAgreement,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "credit support agreement@en",
...
(def CreditSupportBeneficiary
  ...
  {:db/ident :fibo-der-drc-ma/CreditSupportBeneficiary,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "credit support beneficiary@en",
...
(def CreditSupportDefaultEvent
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "credit support default event@en",
   ...
   :skos/definition #xsd/langString
                     "Failure of some Credit Support Agreement.@en"})
...
(def CrossDefaultProvisions
  ...
  {:db/ident :fibo-der-drc-ma/CrossDefaultProvisions,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "cross default provisions@en",
...
(def CurrencySpecificationTerm
  ...
  {:db/ident :fibo-der-drc-ma/CurrencySpecificationTerm,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "currency specification term@en",
   :rdfs/subClassOf [:fibo-fnd-agr-ctr/ContractualDefinition
                     :fibo-der-drc-ma/MasterAgreementElement
                     :fibo-fnd-agr-ctr/ContractualElement],
   :skos/definition
   #xsd/langString "Term defining the currency or currencies for payments.@en",
   :skos/editorialNote
   #xsd/langString "is found in general terms in example Master Agreement.@en"})
...
(def DefaultInterestObligation
  ...
  {:db/ident :fibo-der-drc-ma/DefaultInterestObligation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "default interest obligation@en",
...
(def DerivativeTransactionMasterAgreement
  ...
  {:db/ident :fibo-der-drc-ma/DerivativeTransactionMasterAgreement,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "derivative transaction master agreement@en",
...
(def MasterAgreementAccountChangeNotificationObligation
  ...
  {:db/ident
   ...
   :skos/definition
   #xsd/langString
    "The obligtation to notify the counterparty to this agreement, of any changes in account details.@en",
   :skos/example
   #xsd/langString
    "Example text: \"Either party may change its account for receiving a payment or delivery by giving notice to the other party at least five Local Business Days prior to the scheduled date for the payment or delivery to which such change applies unless such other party gives timely notice of a reasonable objection to such change.\" Note that the notice period is given as a fact about the general kind of obligation which is Master Agreement Change notification Obligation.@en"})
...
(def MasterAgreementChangeNotificationObligation
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString "General term of which Change of Account is an example.@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString
                "master agreement change notification obligation@en",
   :rdfs/subClassOf :fibo-fnd-law-lcap/ContractualObligation,
   :skos/definition
   #xsd/langString
...
(def MasterAgreementConditionsPrecedent
  ...
  {:db/ident :fibo-der-drc-ma/MasterAgreementConditionsPrecedent,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement conditions precedent@en",
...
(def MasterAgreementContractualCommitment
  ...
  {:db/ident :fibo-der-drc-ma/MasterAgreementContractualCommitment,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement contractual commitment@en",
...
(def MasterAgreementEarlyTerminationProvisions
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "Terms here include: Additional Terminaton Event Affected Parties@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString
                "master agreement early termination provisions@en",
   :rdfs/subClassOf
...
(def MasterAgreementEarlyTerminationRight
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "This generally arises from some Default Event on the part of the other party.@en",
   :db/ident :fibo-der-drc-ma/MasterAgreementEarlyTerminationRight,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement early termination right@en",
...
(def MasterAgreementElement
  ...
  {:db/ident :fibo-der-drc-ma/MasterAgreementElement,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement element@en",
   ...
   :skos/editorialNote
   #xsd/langString
    "This is included so that all OTC Master Agreement Contract Terms Sets may be included under this one set. Terms are also described as specializations of the sorts of terms that they are (e.g. conditions Precedent, Commitments Terms and so on).@en"})
...
(def MasterAgreementObligationTerms
  ...
  {:db/ident :fibo-der-drc-ma/MasterAgreementObligationTerms,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement obligations terms@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fnd-agr-ctr/definesTermsFor,
                      :owl/someValuesFrom
                      :fibo-fnd-law-lcap/ContractualObligation,
                      :rdf/type :owl/Restriction}
...
(def MasterAgreementRightToTerminationFollowingDefaultEvent
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/label
   #xsd/langString
    "master agreement right to termination following default event@en",
...
(def MasterAgreementTerminationEvent
  ...
  {:db/ident :fibo-der-drc-ma/MasterAgreementTerminationEvent,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement termination event@en",
...
(def MasterAgreementTerminationProvision
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "Early Termination is a specific set of terms within this, that are specific to this kind of Master Agreement.@en",
   :db/ident :fibo-der-drc-ma/MasterAgreementTerminationProvision,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement termination provision@en",
   ...
   :skos/definition
   #xsd/langString
    "a provision in the master agreement, setting out the conditions, consequences etc. of termination of the agreement@en"})
...
(def NettingTerms
  ...
  {:db/ident :fibo-der-drc-ma/NettingTerms,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "netting terms@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fnd-agr-ctr/definesTermsFor,
                      :owl/someValuesFrom
...
(def ObligationInRespectOfNetting
  ...
  {:db/ident :fibo-der-drc-ma/ObligationInRespectOfNetting,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "obligation in respect of netting@en",
...
(def OtherAmountsObligation
  ...
  {:db/ident :fibo-der-drc-ma/OtherAmountsObligation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "other amounts obligation@en",
   :rdfs/subClassOf :fibo-fnd-law-lcap/ContractualObligation,
   :skos/definition
   #xsd/langString
...
(def PaymentObligationAsDelivery
  ...
  {:db/ident :fibo-der-drc-ma/PaymentObligationAsDelivery,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payment obligation as delivery@en",
   :rdfs/subClassOf [:fibo-der-drc-ma/PaymentObligation
                     :fibo-fnd-law-lcap/ContractualObligation],
   :skos/definition
   #xsd/langString
    "Obligation for payment in settlement of a transaction when this payment takes the form of delivery of some payment in kind.@en",
   :skos/example
   #xsd/langString
    "Sample text: \"... Where settlement is by delivery (that is, other than by payment), such delivery will be made for receipt on the due date in the manner customary for the relevant obligation unless otherwise specified in the relevant Confirmation or elsewhere in this Agreement. \"@en"})
...
(def PaymentPlaceSpecificationMethod
  ...
  {:db/ident :fibo-der-drc-ma/PaymentPlaceSpecificationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payment place specification method@en",
...
(def PaymentPlaceSpecifiedInConfirmationMessage
  ...
  {:db/ident :fibo-der-drc-ma/PaymentPlaceSpecifiedInConfirmationMessage,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString
                "payment place specified in confirmation message@en",
   :rdfs/subClassOf [:fibo-der-drc-ma/PaymentPlaceSpecificationMethod
                     :fibo-fnd-gao-obj/Strategy]})
...
(def PaymentPlaceSpecifiedInMasterAgreement
  ...
  {:db/ident :fibo-der-drc-ma/PaymentPlaceSpecifiedInMasterAgreement,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payment place specified in master agreement@en",
   :rdfs/subClassOf [:fibo-der-drc-ma/PaymentPlaceSpecificationMethod
                     :fibo-fnd-gao-obj/Strategy]})
...
(def TaxWithholdingLiability
  ...
  {:db/ident :fibo-der-drc-ma/TaxWithholdingLiability,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "tax withholding liability@en",
   :rdfs/subClassOf [:fibo-der-drc-ma/TaxWithholdingObligation
                     :fibo-fnd-law-lcap/ContractualObligation],
   :skos/definition
   #xsd/langString
    "Obligation in respect of liability for tax. This defines whether or not the party which is required to deduct some tax payment and does not do so, is then entitled to receive the funds from the other party in the event that a liability for this tax is later assessed against the first party.@en",
   :skos/example
   #xsd/langString
    "Example text: Liability. If:- (1) X is required by any applicable law, as modified by the practice of any relevant governmental revenue authority, to make any deduction or withholding in respect of which X would not be required to pay an additional amount to Y under Section 2(d)(i)(4); (2) X does not so deduct or withhold; and (3) a liability resulting from such Tax is assessed directly against X, then, except to the extent Y has satisfied or then satisfies the liability resulting from such Tax, Y will promptly pay to X the amount of such liability (including any related liability for interest, but including any related liability for penalties only if Y has failed to comply with or perform any agreement contained in Section 4(a)(i), 4(a)(iii) or 4(d)).@en"})
...
(def TaxWithholdingObligation
  ...
  {:db/ident :fibo-der-drc-ma/TaxWithholdingObligation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "tax withholding obligation@en",
   :rdfs/subClassOf :fibo-fnd-law-lcap/ContractualObligation,
   :skos/definition #xsd/langString
...
(def automaticNettingApplicable
  ...
  {:db/ident :fibo-der-drc-ma/automaticNettingApplicable,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "automatic netting applicable@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether netting takes place automatically in respect of one transaction. Example text: \"If on any date amounts would otherwise be payable:- (i) in the same currency; and (ii) in respect of the same Transaction, by each party to the other, then, on such date, each party’s obligation to make payment of any such amount will be automatically satisfied and discharged and, if the aggregate amount that would otherwise have been payable by one party exceeds the aggregate amount that would otherwise have been payable by the other party, replaced by an obligation upon the party by whom the larger aggregate amount would have been payable to pay to the other party the excess of the larger aggregate amount over the smaller aggregate amount. \"@en"})
...
(def changeOfAccountDetailsAllowed
  ...
  {:db/ident :fibo-der-drc-ma/changeOfAccountDetailsAllowed,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "change of account details allowed@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether the account details may be varied for individual transactions transacted under this Master Agreement.@en"})
...
(def compensateOtherParty
  ...
  {:db/ident :fibo-der-drc-ma/compensateOtherParty,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "compensate other party@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether or not, under the stated circumstances, if a party defaults in the performance of any obligation required to be settled by delivery, it is obliged to compensate the other party on demand if and to the extent provided for in the relevant Confirmation or elsewhere in this Agreement.@en"})
...
(def crossTransactionNettingElection
  ...
  {:db/ident :fibo-der-drc-ma/crossTransactionNettingElection,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "cross transaction netting election@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether either party may elect to carry out netting in respect of two or more transactions carried out under this Master Agreement.@en"})
...
(def currencySpecificMethods
  ...
  {:db/ident :fibo-der-drc-ma/currencySpecificMethods,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "currency specific methods@en",
   :skos/definition
   #xsd/langString
    "Payment is to be in the manner customary for the currency in question. Example text: \"... in the manner customary for payments in the required currency.\" It is not clear what if anything the alternative would be. Included as a \"yes/no\" term for completeness.@en"})
...
(def defaultInterestApplicable
  ...
  {:db/ident :fibo-der-drc-ma/defaultInterestApplicable,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "default interest applicable@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether a party that defaults in the performance of any payment obligation will, to the extent permitted by law and this agreement be required to pay interest (before as well as after judgment) on the overdue amount to the other party on demand in the same currency as such overdue amount, for the period from (and including) the original due date for payment to (but excluding) the date of actual payment.@en"})
...
(def defaultInterestCompoundingBasis
  ...
  {:db/ident :fibo-der-drc-ma/defaultInterestCompoundingBasis,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "default interest compounding basis@en",
   :rdfs/range :cmns-dt/DatePeriod,
   :skos/definition
   #xsd/langString
    "The basis upon which default interest is to be calculated, as a period of time (e.g. daily).@en"})
...
(def describesTreatmentOf
  ...
  {:db/ident :fibo-der-drc-ma/describesTreatmentOf,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "describes treatment of@en",
...
(def dischargedByNetting
  ...
  {:db/ident :fibo-der-drc-ma/dischargedByNetting,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "discharged by netting@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "The obligations for payment by either party is automatically discharged or satisfied in the event of other amounts being due on the same day and in the same currency. The Obligation in question is ether discharged completely or replaced with an obligation in respect of the outstanding difference, on the part of whichever party has a greater amount due to the other (a positive amount after netting) for that transaction on that date.@en"})
...
(def effectOfDesignation
  ...
  {:db/ident :fibo-der-drc-ma/effectOfDesignation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "effect of designation@en",
   :rdfs/range :xsd/string,
   :skos/definition
   #xsd/langString
    "Description of the effect of designation of this right.@en"})
...
(def forward
  ...
  {:db/ident :fibo-der-drc-ma/forward,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "forward@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "If a party is required to deduct or withhold tax, whether that party is to promptly forward to the other party an official receipt (or a certified copy), or other documentation reasonably acceptable to that party, evidencing such payment to such authorities.@en"})
...
(def freelyTransferableFunds
  ...
  {:db/ident :fibo-der-drc-ma/freelyTransferableFunds,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "freely transferable funds@en",
   :rdfs/range :xsd/boolean})
...
(def hasBeneficiary
  ...
  {:db/ident :fibo-der-drc-ma/hasBeneficiary,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "has beneficiary@en",
...
(def hasEarlyTerminationDate
  ...
  {:db/ident :fibo-der-drc-ma/hasEarlyTerminationDate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "has early termination date@en",
...
(def inDefault
  ...
  {:db/ident :fibo-der-drc-ma/inDefault,
   ...
   :skos/definition
   #xsd/langString
    "The condition that some default has occurred in respect to the other party. Further notes: Conditions precedent typically include that no default has occurred, so this is typically or always \"no\". Sample text (of which this term is a part): \" the condition precedent that no Event of Default or Potential Event of Default with respect to the other party has occurred and is continuing, \"@en"})
...
(def includesPenaltyPayments
  ...
  {:db/ident :fibo-der-drc-ma/includesPenaltyPayments,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "includes penalty payments@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether liability on the part of the counterparty (the party which is not assessed as being liable for the relevant tax) includes liability for penalties in respect of the late or non payment of that tax by the party so assessed.@en"})
...
(def invokedInEventOf
  ...
  {:db/ident :fibo-der-drc-ma/invokedInEventOf,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "invoked in event of@en",
   :rdfs/range :fibo-der-drc-ma/MasterAgreementTerminationEvent})
...
(def isFailureInForceOf
  ...
  {:db/ident :fibo-der-drc-ma/isFailureInForceOf,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "is failure in force of@en",
...
(def isPredicatedOn
  ...
  {:db/ident :fibo-der-drc-ma/isPredicatedOn,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "is predicated on@en",
...
(def makeUpForIndemnifiable
  ...
  {:db/ident :fibo-der-drc-ma/makeUpForIndemnifiable,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "make up for indemnifiable@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "If a party (\"X\") is required to deduct or withhold tax, and if such Tax is an Indemnifiable Tax, whether X is to pay to the other party (\"Y\"), in addition to the payment to which Y is otherwise entitled under this Agreement, such additional amount as is necessary to ensure that the net amount actually received by Y (free and clear of Indemnifiable Taxes, whether assessed against X or Y) will equal the full amount Y would have received had no such deduction or withholding been required. However, X will not be required to pay any additional amount to Y to the extent that it would not be required to be paid but for:- (A) the failure by Y to comply with or perform any agreement contained in the provisions for furnishing specified information in this agreement; or (B) the failure of a representation made by Y pursuant to the Representation Section of the agreement to be accurate and true unless such failure would not have occurred but for (I) any action taken by a taxing authority, or brought in a court of competent jurisdiction, on or after the date on which a Transaction is entered into (regardless of whether such action is taken or brought with respect to a party to this Agreement) or (II) a Change in Tax Law. Further notes: The above is all definitional of this term.@en"})
...
(def masterAgreementCurrency
  ...
  {:db/ident :fibo-der-drc-ma/masterAgreementCurrency,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "master agreement currency@en",
   :rdfs/range :fibo-fnd-acc-cur/Currency,
   :skos/definition
   #xsd/langString
    "The currency for payments under this Master Agreement. ISDA Master Agreement example text: Payment in the Contractual Currency. Each payment under this Agreement will be made in the relevant currency specified in this Agreement for that payment (the \"Contractual Currency\"). To the extent permitted by applicable law, any obligation to make payments under this Agreement in the Contractual Currency will not be discharged or satisfied by any tender in any currency other than the Contractual Currency, except to the extent such tender results in the actual receipt by the party to which payment is owed, acting in a reasonable manner and in good faith in converting the currency so tendered into the Contractual Currency, of the full amount in the Contractual Currency of all amounts payable in respect of this Agreement. If for any reason the amount in the Contractual Currency so received falls short of the amount in the Contractual Currency payable in respect of this Agreement, the party required to make the payment will, to the extent permitted by applicable law, immediately pay such additional amount in the Contractual Currency as may be necessary to compensate for the shortfall. If for any reason the amount in the Contractual Currency so received exceeds the amount in the Contractual Currency payable in respect of this Agreement, the party receiving the payment will refund promptly the amount of such excess.@en"})
...
(def mayBeVariedByOne
  ...
  {:db/ident :fibo-der-drc-ma/mayBeVariedByOne,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "may be varied by one@en",
...
(def notify
  ...
  {:db/ident :fibo-der-drc-ma/notify,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "notify@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "If a party is required to deduct or withhold tax, whether obligation is to promptly notify the other party of Tax Withholding Grossup requirement.@en"})
...
(def ongoingDefault
  ...
  {:db/ident :fibo-der-drc-ma/ongoingDefault,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "ongoing default@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "The condition that some default or potential default is ongoing in respect to the other party. Further notes: Conditions precedent typically include that no default is ongoing, so this is typically or always \"no\". Sample text (of which this term is a part): \" the condition precedent that no Event of Default or Potential Event of Default with respect to the other party has occurred and is continuing, \"@en"})
...
(def pay
  ...
  {:db/ident :fibo-der-drc-ma/pay,
   ...
   :skos/definition
   #xsd/langString
    "If a party \"X\" is required to deduct or withhold tax, whether Obligation is to pay to the relevant authorities the full amount required to be deducted or withheld (including the full amount required to be deducted or withheld from any additional amount paid by X to Y under this obligation promptly upon the earlier of determining that such deduction or withholding is required or receiving notice that such amount has been assessed against Y;@en"})
...
(def payableByCounterparty
  ...
  {:db/ident :fibo-der-drc-ma/payableByCounterparty,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payable by counterparty@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether the counterparty is obliged to promptly pay to the party which is assessed as being liable for the relevant tax, the amount of such liability.@en"})
...
(def paymentDateCalculationRequirement
  ...
  {:db/ident :fibo-der-drc-ma/paymentDateCalculationRequirement,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payment date calculation requirement@en",
   :rdfs/range :xsd/string,
   :skos/definition
   #xsd/langString
    "Provisions for calculation of Payment dates in the event of this Early Termination.@en"})
...
(def paymentInKindDeliveryObligation
  ...
  {:db/ident :fibo-der-drc-ma/paymentInKindDeliveryObligation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payment in kind delivery obligation@en",
   :rdfs/range :xsd/string,
   :skos/definition
   #xsd/langString
    "Precise description of the form in which payment is to be made when payment is in kind.@en"})
...
(def paymentPlaceSpecification
  ...
  {:db/ident :fibo-der-drc-ma/paymentPlaceSpecification,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "payment place specification@en",
   :rdfs/range :fibo-der-drc-ma/PaymentPlaceSpecificationMethod,
   :skos/definition
   #xsd/langString
    "The place for payments specified in this Master Agreement.@en"})
...
(def potentialDefault
  ...
  {:db/ident :fibo-der-drc-ma/potentialDefault,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "potential default@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "The condition that some potential default has occurred in respect to the other party. Further notes: Conditions precedent typically include that no potential default has occurred, so this is typically or always \"no\". Sample text (of which this term is a part): \" the condition precedent that no Event of Default or Potential Event of Default with respect to the other party has occurred and is continuing, \"@en"})
...
(def requiredDaysNotice
  ...
  {:db/ident :fibo-der-drc-ma/requiredDaysNotice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "required days notice@en",
   :rdfs/range :xsd/integer,
   :skos/definition
   #xsd/langString
    "The number of days notice to be given for a change in the given kinds of details.@en"})
...
(def specifiedIndebtedness
  ...
  {:db/ident :fibo-der-drc-ma/specifiedIndebtedness,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "specified indebtedness@en",
   :rdfs/range :xsd/string,
   :skos/definition
   #xsd/langString
    "Any obligation (whether present or future, contingent or otherwise, as principal or surety or otherwise) in respect of borrowed money. May not include obligations in respect of deposits received in the ordinary course of a party’s banking business. FpML: In Schedule: \"Specified Indebtedness\" will have the meaning specified in Section 14 except that such term shall not include obligations in respect of deposits received in the ordinary course of a party’s banking business. Section 14: \"Specified Indebtedness\" means, subject to the Schedule, any obligation (whether present or future, contingent or otherwise, as principal or surety or otherwise) in respect of borrowed money. Modeling note: Could extend this to have a yes/no option on the exclusion described in the Schedule to the sample Master Agreement@en"})
...
(def statementCalculationRequirements
  ...
  {:db/ident :fibo-der-drc-ma/statementCalculationRequirements,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "statement calculation requirements@en",
   :rdfs/range :xsd/string,
   :skos/definition
   #xsd/langString
    "Provisions for calculation of statements and statement amounts in the event of this Early Termination.@en"})
...
(def subjectToOtherProvisions
  ...
  {:db/ident :fibo-der-drc-ma/subjectToOtherProvisions,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "subject to other provisions@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether this Obligation is subject to other provisions in the Master Agreement.@en"})
...
(def thresholdAmount
  ...
  {:db/ident :fibo-der-drc-ma/thresholdAmount,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "threshold amount@en",
...
(def transactionEarlyTerminationDate
  ...
  {:db/ident :fibo-der-drc-ma/transactionEarlyTerminationDate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/DerivativesMasterAgreements/"},
   :rdfs/label #xsd/langString "transaction early termination date@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "The condition that some early termination date as been defined in respect to the transaction carried out under this Master Agreement. Further notes: note that this is in respect of a specific transaction transacted under the Master Agreement, so that the condition precedent for the obligation in respect of that specific transaction, is that this early transaction termation has not taken place in respect of this same transaction. Conditions precedent typically include this is not the case, so this is typically or always \"no\". Sample text: \"the condition precedent that no Early Termination Date in respect of the relevant Transaction has occurred or been effectively designated.\"@en"})