(ns net.wikipunk.rdf.fibo-der-drc-exo
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 Object Management Group, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "Exotic Options Ontology@en",
   :skos/changeNote
...
(def AsianOption
  ...
  {:cmns-av/adaptedFrom
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "Asian option@en",
...
(def AveragingStrategy
  ...
  {:db/ident :fibo-der-drc-exo/AveragingStrategy,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "averaging strategy@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cls/classifies,
                      :owl/someValuesFrom :fibo-der-drc-exo/AsianOption,
                      :rdf/type           :owl/Restriction}
                     :fibo-fnd-gao-obj/Strategy
...
(def CliquetOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #voc/lstr "rachet option@en",
   :db/ident :fibo-der-drc-exo/CliquetOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "cliquet option@en",
...
(def CommodoreOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "commodore option@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/comprises,
...
(def CompoundOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #voc/lstr "split-fee options@en",
   :db/ident :fibo-der-drc-exo/CompoundOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "compound option@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/comprises,
...
(def DigitalOption
  ...
  {:cmns-av/adaptedFrom
   ...
   :cmns-av/synonym #voc/lstr "binary option@en",
...
(def FixedLookbackStrikeExpression
  ...
  {:db/ident :fibo-der-drc-exo/FixedLookbackStrikeExpression,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "fixed lookback strike expression@en",
...
(def FloatingLookbackStrikeExpression
  ...
  {:db/ident :fibo-der-drc-exo/FloatingLookbackStrikeExpression,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "floating lookback strike expression@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasSubtrahend,
                      :owl/someValuesFrom :fibo-der-drc-exo/ObservedBestValue,
                      :rdf/type           :owl/Restriction}
                     {:owl/onProperty :fibo-fnd-utl-alx/hasMinuend,
...
(def ForwardStartOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "forward start option@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/comprises,
...
(def KnockInOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "knock-in option@en",
...
(def KnockOutOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "knock-out option@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-der-drc-exo/hasFirstBarrierPrice,
                      :owl/someValuesFrom :fibo-fnd-acc-cur/MonetaryPrice,
                      :rdf/type :owl/Restriction}
                     {:owl/minQualifiedCardinality 0,
...
(def LookbackOption
  ...
  {:cmns-av/adaptedFrom
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "lookback option@en",
...
(def LowExercisePriceOption
  ...
  {:cmns-av/abbreviation #voc/lstr "LEPO@en",
   :cmns-av/explanatoryNote
   #voc/lstr
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "low exercise price option@en",
...
(def MountainRangeOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "mountain range option@en",
...
(def ObservedBestValue
  ...
  {:db/ident :fibo-der-drc-exo/ObservedBestValue,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "observed best value@en",
...
(def ProjectedValueAtMaturity
  ...
  {:db/ident :fibo-der-drc-exo/ProjectedValueAtMaturity,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "projected value at maturity@en",
...
(def RainbowOption
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "rainbow option@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom :fibo-sec-sec-bsk/MixedBasket,
                      :rdf/type           :owl/Restriction}
                     :fibo-der-drc-opt/ExoticOption
...
(def Swaption
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #voc/lstr "swap option@en",
   :db/ident :fibo-der-drc-exo/Swaption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "swaption@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def hasMonitoringFrequency
  ...
  {:db/ident :fibo-der-drc-exo/hasMonitoringFrequency,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "has monitoring frequency@en",
...
(def isAboveStrikePrice
  ...
  {:db/ident :fibo-der-drc-exo/isAboveStrikePrice,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "is above strike price@en",
...
(def usesWeightedAverage
  ...
  {:db/ident :fibo-der-drc-exo/usesWeightedAverage,
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #voc/lstr "uses weighted average@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #voc/lstr
