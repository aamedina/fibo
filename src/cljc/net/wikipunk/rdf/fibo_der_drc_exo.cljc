(ns net.wikipunk.rdf.fibo-der-drc-exo
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 Object Management Group, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/",
   :rdfs/label #xsd/langString "Exotic Options Ontology@en",
   :skos/changeNote
...
(def AveragingStrategy
  ...
  {:db/ident :fibo-der-drc-exo/AveragingStrategy,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "averaging strategy@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cls/classifies,
                      :owl/someValuesFrom :fibo-der-drc-exo/AsianOption,
                      :rdf/type           :owl/Restriction}
                     :fibo-fnd-gao-obj/Strategy],
...
(def BarrierOption
  ...
  {:cmns-av/adaptedFrom
   ...
   :skos/note
   #xsd/langString
    "For a knock-out barrier option, the option is cancelled if the underlying price crosses a predetermined barrier level; for a knock-in barrier option, the option becomes available-for-exercise if the underlying price crosses a predetermined barrier level.@en"})
...
(def CommodoreOption
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "Sometimes the digital barrier increases with the number of years since the trade began. All of the options are active from the start of the trade.@en",
   :db/ident :fibo-der-drc-exo/CommodoreOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "commodore option@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/comprises,
...
(def DoubleBarrierOption
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "double barrier option@en",
   :rdfs/subClassOf [:fibo-der-drc-exo/BarrierOption
...
(def FixedLookbackStrikeExpression
  ...
  {:db/ident :fibo-der-drc-exo/FixedLookbackStrikeExpression,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "fixed lookback strike expression@en",
...
(def FloatingLookbackStrikeExpression
  ...
  {:db/ident :fibo-der-drc-exo/FloatingLookbackStrikeExpression,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "floating lookback strike expression@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasSubtrahend,
                      :owl/someValuesFrom :fibo-der-drc-exo/ObservedBestValue,
                      :rdf/type           :owl/Restriction}
                     {:owl/onProperty :fibo-fnd-utl-alx/hasMinuend,
...
(def ForwardStartOption
  ...
  {:cmns-av/explanatoryNote
   [#xsd/langString
     "The only unknown for the contract is the strike price. In terms of pricing the contract, the future price of the underlying asset is also unknown. The contract typically stipulates some parameters for where the strike price will be in relation to the underlying asset's price.@en"
    #xsd/langString
     "Forward start options typically attempt to keep future strike prices at the money or near the money. In this way, the holder will have the right, but not the obligation, to buy (call) or sell (put) the underlying asset in the future at or near the then-current market price. Knowing where the strike price will be in relation to the underlying's price makes it easier to come up with the premium (cost) of the option, which is also typically determined and paid at the initiation of the contract prior to the activation date. If, at the expiration date, the underlying trades below the strike price of the option (for a call), then it expires worthless. If the underlying is above the strike (for a call), then the holder exercises it and owns the underlying at the strike price. For a put option, if the underlying is below the strike price, the option has value and will be sold or exercised to realize a gain. If the underlying is above the strike price, the option will expire worthless. Typically, as with most options, the holder may sell the option if it is in the money and take the cash instead of exercising the option. Since it is an exotic option, the seller and buyer of the option may also agree to settle the option with cash instead of delivering the underlying. Once a forward start option becomes active (strike price is set), then the option is valued like a vanilla option.@en"],
   :db/ident :fibo-der-drc-exo/ForwardStartOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "forward start option@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/comprises,
...
(def InterestRateCapOption
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "The interest in each period is effectively capped by the strike rate. That is, the rate of interest may not go above the strike rate because the holder is expected to exercise the option to take the strike as the rate of interest instead.@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "interest rate cap option@en",
   ...
   :skos/example
   #xsd/langString
    "An example of a cap would be an agreement to receive a payment for each month the LIBOR rate exceeds 2.5%.@en"})
...
(def InterestRateFloorOption
  ...
  {:db/ident :fibo-der-drc-exo/InterestRateFloorOption,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "interest rate floor option@en",
   :rdfs/subClassOf :fibo-der-drc-opt/InterestRateOption,
   :skos/definition
   #xsd/langString
...
(def KnockInOption
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "If the price is never reached, it is as if the contract never existed. However, if the underlying asset reaches a specified barrier, the knock-in option comes into existence. The difference between a knock-in and knock-out option is that a knock-in option comes into existence only when the underlying security reaches a barrier, while a knock-out option ceases to exist when the underlying security reaches a barrier.@en",
   :db/ident :fibo-der-drc-exo/KnockInOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "knock-in option@en",
...
(def KnockOutOption
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "A knock-out option sets a cap on the level an option can reach in the holder's favor. As knock-out options limit the profit potential for the option buyer, they can be purchased for a smaller premium than an equivalent option without a knock-out stipulation.@en",
   :db/ident :fibo-der-drc-exo/KnockOutOption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "knock-out option@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-der-drc-exo/hasFirstBarrierPrice,
                      :owl/someValuesFrom :fibo-fnd-acc-cur/MonetaryPrice,
                      :rdf/type :owl/Restriction}
                     {:owl/minQualifiedCardinality #xsd/nonNegativeInteger 0,
...
(def LookbackStrikeTerms
  ...
  {:cmns-av/explanatoryNote
   [#xsd/langString
     "In the case of a fixed strike, the terms depend on whether the option is a call or put. If it is a call, the calculated payout reflects the difference between a running maximum value of the observable during the lookback period, and the pre-agreed strike.@en"
    #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "lookback strike terms@en",
   :rdfs/subClassOf
...
(def ObservedBestValue
  ...
  {:db/ident :fibo-der-drc-exo/ObservedBestValue,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "observed best value@en",
...
(def ProjectedValueAtMaturity
  ...
  {:db/ident :fibo-der-drc-exo/ProjectedValueAtMaturity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "projected value at maturity@en",
...
(def Swaption
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "A swaption, also known as a swap option, refers to an option to enter into an interest rate swap or some other type of swap. In exchange for an options premium, the buyer gains the right but not the obligation to enter into a specified swap agreement with the issuer on a specified future date.@en",
   :cmns-av/synonym #xsd/langString "swap option@en",
   :db/ident :fibo-der-drc-exo/Swaption,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "swaption@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
...
(def hasAsianTailPeriod
  ...
  {:db/ident :fibo-der-drc-exo/hasAsianTailPeriod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has Asian tail period@en",
...
(def hasFirstBarrierPrice
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "For a double barrier option, this is the level of the first barrier. Otherwise it is the only barrier price.@en",
   :db/ident :fibo-der-drc-exo/hasFirstBarrierPrice,
   :rdf/type :owl/ObjectProperty,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has first barrier price@en",
...
(def hasFirstRebateAmount
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "Both knock-out and knock-in barrier options can contain a provision to provide rebates to holders, if the option does not reach the barrier price and becomes worthless.@en",
   :db/ident :fibo-der-drc-exo/hasFirstRebateAmount,
   :rdf/type :owl/ObjectProperty,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has first rebate amount@en",
...
(def hasLookbackPeriod
  ...
  {:db/ident :fibo-der-drc-exo/hasLookbackPeriod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has lookback period@en",
   :rdfs/range :cmns-dt/DatePeriod,
   :rdfs/subPropertyOf :cmns-dt/hasDatePeriod,
   :skos/definition
   #xsd/langString "window of time during which the lookback is effective@en"})
...
(def hasMonitoringFrequency
  ...
  {:db/ident :fibo-der-drc-exo/hasMonitoringFrequency,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has monitoring frequency@en",
   :rdfs/range :xsd/positiveInteger,
   :skos/definition
   #xsd/langString
    "has frequency with respect to how often, in days, the asset price is checked to see if the barrier has been breached@en"})
...
(def hasMonitoringPeriod
  ...
  {:db/ident :fibo-der-drc-exo/hasMonitoringPeriod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has monitoring period@en",
   :rdfs/range :cmns-dt/DatePeriod,
   :rdfs/subPropertyOf :cmns-dt/hasDatePeriod,
   :skos/definition #xsd/langString
...
(def hasOptionTypeElectionDate
  ...
  {:db/ident :fibo-der-drc-exo/hasOptionTypeElectionDate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has option type election date@en",
...
(def hasSecondBarrierPrice
  ...
  {:db/ident :fibo-der-drc-exo/hasSecondBarrierPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has second barrier price@en",
   :rdfs/range :fibo-fnd-acc-cur/MonetaryPrice,
   :rdfs/subPropertyOf :fibo-fnd-acc-cur/hasPrice,
   :skos/definition
   #xsd/langString
...
(def hasSecondRebateAmount
  ...
  {:db/ident :fibo-der-drc-exo/hasSecondRebateAmount,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "has second rebate amount@en",
   :rdfs/range :fibo-fnd-acc-cur/PercentageMonetaryAmount,
   :rdfs/subPropertyOf :fibo-fnd-acc-cur/hasPrice,
   :skos/definition
   #xsd/langString
...
(def isAboveStrikePrice
  ...
  {:db/ident :fibo-der-drc-exo/isAboveStrikePrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "is above strike price@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "indicates whether the barrier is crossed when the price of the underlier is above (or below, if not) the strike price (threshold)@en"})
...
(def usesCurrencyInAveraging
  ...
  {:db/ident :fibo-der-drc-exo/usesCurrencyInAveraging,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "uses currency in averaging@en",
...
(def usesWeightedAverage
  ...
  {:db/ident :fibo-der-drc-exo/usesWeightedAverage,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/DER/DerivativesContracts/ExoticOptions/"},
   :rdfs/label #xsd/langString "uses weighted average@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "indicates whether a weighted average is being used to calculate the average rate or strike price@en"})