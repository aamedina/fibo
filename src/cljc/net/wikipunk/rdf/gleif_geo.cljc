(ns net.wikipunk.rdf.gleif-geo
  ...
  {:dcat/downloadURL
   ...
   [{:rdfa/uri
    ...
    {:rdfa/uri "https://www.gleif.org/en/lei-data/gleif-golden-copy"}],
   :dcterms/title
   #xsd/langString
    "Global Legal Entity Identifier Foundation Geocoding Ontology@en",
   :owl/imports
...
(def BoundingBox
  ...
  {:db/ident :gleif-geo/BoundingBox,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy {:rdfa/uri "https://www.gleif.org/ontology/Geocoding/"},
...
(def GeocodedAddress
  ...
  {:db/ident :gleif-geo/GeocodedAddress,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy {:rdfa/uri "https://www.gleif.org/ontology/Geocoding/"},
   :rdfs/label #xsd/langString "geocoded address@en",
