(ns net.wikipunk.rdf.fibo-fnd-plc-fac
  ^{:base "https://spec.edmcouncil.org/fibo/ontology/FND/Places/Facilities/",
    :namespaces
    ...
    :prefix "fibo-fnd-plc-fac",
    :source "https://spec.edmcouncil.org/fibo/ontology/FND/Places/Facilities/"}
