...
(def ContractuallyCapableEntity
  ...
  {:cmns-av/adaptedFrom {:xsd/string "ISO 17442"},
...
(def EntityLegalForm
  ...
  {:cmns-av/adaptedFrom
   [{:rdfa/uri
    ...
    {:rdfa/uri "https://www.iso.org/obp/ui/#iso:std:iso:20275:ed-1:v1:en"}],
...
(def GenerallyAcceptedAccountingPrinciples
  ...
  {:cmns-av/abbreviation ["US GAAP" "GAAP"],
   ...
   :rdf/type [:fibo-be-le-lei/AccountingFramework
              :owl/NamedIndividual
   ...
   :rdfs/seeAlso {:rdfa/uri "https://www.fasb.org/home"},
   :skos/definition
   "an accounting framework developed by the US Financial Accounting Standards Board (FASB)"})
...
(def InternationalFinancialReportingStandard
  ...
  {:cmns-av/abbreviation "IFRS",
   ...
   :rdfs/seeAlso {:rdfa/uri "https://www.ifrs.org/"},
   :skos/definition
   "an accounting framework developed by the International Accounting Standards Board (IASB)"})
...
(def LegalEntityIdentifier
  ...
  {:cmns-av/adaptedFrom
   [{:rdfa/uri "https://www.iso.org/standard/59771.html"}
    {:rdfa/uri
     "https://www.gleif.org/en/about-lei/common-data-file-format/lei-cdf-format/lei-cdf-format-version-2-1"}],
...
(def RelationshipStatusActive
  ...
  {:cmns-av/adaptedFrom
   ...
   :rdf/type [:fibo-be-le-lei/RelationshipStatus
              :owl/NamedIndividual
              :cmns-cls/Classifier],
   :rdfs/isDefinedBy
   {:rdfa/uri
