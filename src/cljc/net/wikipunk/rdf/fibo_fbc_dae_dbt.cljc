(ns net.wikipunk.rdf.fibo-fbc-dae-dbt
  {:cmns-av/copyright
   ...
   #{"The https://spec.edmcouncil.org/fibo/ontology/FBC/DebtAndEquities/Debt/ version of this ontology was modified to make redemption provision a child of contractual commitment and move it to financial instruments, as such provisions apply to preferred shares and other instruments in addition to debt."
     ...
     "The https://spec.edmcouncil.org/fibo/ontology/FBC/DebtAndEquities/Debt.rdf version of this ontology was modified to include a definition for accrued interest, needed for pricing, and correct certain process (methodology) issues in the class hierarchy (SEC-185)."
...
(def AccruedInterest
  {:cmns-av/explanatoryNote
   ...
   :db/ident :fibo-fbc-dae-dbt/AccruedInterest,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:xsd/anyURI
    "https://spec.edmcouncil.org/fibo/ontology/FBC/DebtAndEquities/Debt/"},
   :rdfs/label {:rdf/language "en",
                :rdf/value    "accrued interest"},
