(ns net.wikipunk.rdf.fibo-sec-sec-pls
  ^{:base "https://spec.edmcouncil.org/fibo/ontology/SEC/Securities/Pools/",
    :namespaces
    ...
    :prefix "fibo-sec-sec-pls",
    :source "https://spec.edmcouncil.org/fibo/ontology/SEC/Securities/Pools/"}
