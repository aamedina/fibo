...
(def Adult
  ...
  {:cmns-av/adaptedFrom {:rdfa/uri "https://en.wikipedia.org/wiki/Adult"},
...
(def Minor
  ...
  {:cmns-av/adaptedFrom {:rdfa/uri "https://en.wikipedia.org/wiki/Minor_(law)"},
   :cmns-av/explanatoryNote
...
(def NationalIdentificationNumber
  ...
  {:cmns-av/adaptedFrom
   {:rdfa/uri "http://en.wikipedia.org/wiki/National_identification_number"},
   :cmns-av/explanatoryNote
