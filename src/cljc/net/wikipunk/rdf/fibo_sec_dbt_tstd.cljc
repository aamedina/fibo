(ns net.wikipunk.rdf.fibo-sec-dbt-tstd
  ...
  {:cmns-av/copyright ["Copyright (c) 2018-2023 EDM Council, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/TradedShortTermDebt/",
   :rdfs/label #voc/lstr "Traded Short-Term Debt Ontology@en",
   :skos/changeNote
...
(def BankersAcceptance
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/TradedShortTermDebt/",
   :rdfs/label #voc/lstr "bankers' acceptance@en",
   :rdfs/subClassOf
...
(def BillOfExchange
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym [#voc/lstr "draft@en" #voc/lstr "bank draft@en"],
...
(def CommercialPaper
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/TradedShortTermDebt/",
   :rdfs/label #voc/lstr "commercial paper@en",
   :rdfs/subClassOf
   [{:owl/hasValue   :fibo-sec-dbt-dbti/ParValue,
     :owl/onProperty :fibo-sec-dbt-dbti/hasRelativePriceAtMaturity,
     :rdf/type       :owl/Restriction}
...
(def RepurchaseAgreement
  ...
  {:cmns-av/abbreviation #voc/lstr "REPO@en",
   :cmns-av/explanatoryNote
   #voc/lstr
   ...
   :rdfs/isDefinedBy
   "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/TradedShortTermDebt/",
   :rdfs/label #voc/lstr "repurchase agreement@en",
