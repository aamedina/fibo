(ns net.wikipunk.rdf.fibo-md-der-fut
  ...
  {:cmns-av/copyright "Copyright (c) 2013-2023 EDM Council, Inc.",
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/",
   :rdfs/label #xsd/langString "Futures Temporal Ontology@en"})
...
(def ExchangeFuturesPrice
  ...
  {:db/ident :fibo-md-der-fut/ExchangeFuturesPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "exchange futures price@en",
...
(def FuturesClosingPrice
  ...
  {:db/ident :fibo-md-der-fut/FuturesClosingPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "futures closing price@en",
...
(def FuturesDailySettlementPrice
  ...
  {:db/ident :fibo-md-der-fut/FuturesDailySettlementPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "futures daily settlement price@en",
   :rdfs/subClassOf :fibo-fbc-fi-ip/SecurityPrice,
   :skos/definition #xsd/langString "Review whether this exists@en"})
...
(def FuturesGreek
  ...
  {:db/ident :fibo-md-der-fut/FuturesGreek,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "futures greek@en",
...
(def FuturesTheta
  ...
  {:db/ident :fibo-md-der-fut/FuturesTheta,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "futures theta@en",
...
(def FuturesTradingAccountHolder
  ...
  {:db/ident :fibo-md-der-fut/FuturesTradingAccountHolder,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "futures trading account holder@en",
   :skos/definition
   #xsd/langString
...
(def FuturesVega
  ...
  {:db/ident :fibo-md-der-fut/FuturesVega,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "futures vega@en",
   :rdfs/subClassOf [:fibo-md-der-fut/FuturesGreek
                     :fibo-fbc-fi-ip/PriceAnalytic]})
...
(def InitialMargin
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "security deposit@en",
   :db/ident :fibo-md-der-fut/InitialMargin,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "initial margin@en",
...
(def MinimumMargin
  ...
  {:db/ident :fibo-md-der-fut/MinimumMargin,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DerivativesTemporal/FuturesTemporal/"},
   :rdfs/label #xsd/langString "minimum margin@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fnd-rel-rel/isHeldBy,
                      :owl/someValuesFrom
                      :fibo-md-der-fut/FuturesTradingAccountHolder,
                      :rdf/type :owl/Restriction}
