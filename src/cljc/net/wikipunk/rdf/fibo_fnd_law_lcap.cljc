(ns net.wikipunk.rdf.fibo-fnd-law-lcap
  ^{:base "https://spec.edmcouncil.org/fibo/ontology/FND/Law/LegalCapacity/",
    :namespaces
    ...
    :prefix "fibo-fnd-law-lcap",
    :source "https://spec.edmcouncil.org/fibo/ontology/FND/Law/LegalCapacity/"}
