(ns net.wikipunk.rdf.fibo-sec-dbt-pbs
  ...
  {:cmns-av/copyright ["Copyright (c) 2015-2023 EDM Council, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/",
   :rdfs/label #xsd/langString "Pool-backed Securities Ontology@en",
   :skos/changeNote
...
(def AbsolutePrepaymentRate
  ...
  {:cmns-av/abbreviation #xsd/langString "ABS@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "absolute prepayment rate@en",
...
(def AssetBackedSecurity
  ...
  {:cmns-av/abbreviation #xsd/langString "ABS@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "asset-backed security@en",
...
(def DebtPoolStatisticalMeasure
  ...
  {:db/ident :fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "debt pool statistical measure@en",
...
(def DefaultRate
  ...
  {:db/ident :fibo-sec-dbt-pbs/DefaultRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "default rate@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
...
(def PoolBackedSecurity
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "pool-backed security@en",
...
(def PrepaymentSpeed
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "prepayment speed@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
                     :fibo-fnd-utl-alx/QualifiedMeasure
                     {:owl/minQualifiedCardinality #xsd/nonNegativeInteger 0,
                      :owl/onClass    :cmns-dt/DatePeriod,
...
(def PrincipalProtectedNote
  ...
  {:cmns-av/adaptedFrom
   ...
   :cmns-av/synonym #xsd/langString "capital protected note@en",
   :db/ident :fibo-sec-dbt-pbs/PrincipalProtectedNote,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "principal protected note@en",
...
(def SingleMonthlyMortality
  ...
  {:cmns-av/abbreviation #xsd/langString "SMM@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "single monthly mortality@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
...
(def StructuredFinanceInstrument
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "structured finance@en",
   :db/ident :fibo-sec-dbt-pbs/StructuredFinanceInstrument,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "structured finance instrument@en",
   :rdfs/seeAlso {:rdfa/uri "https://www.bis.org/publ/cgfs23mitchell.pdf"},
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/PoolBackedSecurity
                     {:owl/onProperty     :fibo-fnd-rel-rel/isIssuedBy,
                      :owl/someValuesFrom {:owl/onProperty
                                           :fibo-fnd-pty-rl/isPlayedBy,
...
(def StructuredFinanceWithoutPrincipalProtection
  ...
  {:cmns-av/adaptedFrom
   ...
   :cmns-av/synonym #xsd/langString
   ...
   :rdfs/label #xsd/langString
                "structured finance without principal protection@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/StructuredFinanceInstrument
                     {:owl/onProperty     :fibo-fbc-dae-dbt/isBasedOn,
                      :owl/someValuesFrom :fibo-sec-sec-pls/InstrumentPool,
                      :rdf/type           :owl/Restriction}
...
(def Tranche
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "tranche@en",
   :rdfs/subClassOf
   ...
   :skos/definition
   #xsd/langString
    "segment of a pool of securities, typically debt instruments@en"})
...
(def WeightedAverageCoupon
  ...
  {:cmns-av/abbreviation #xsd/langString "WAC@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "weighted average coupon@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
...
(def WeightedAverageLife
  ...
  {:cmns-av/abbreviation #xsd/langString "WAL@en",
   :cmns-av/explanatoryNote
   [#xsd/langString
   ...
   :cmns-av/synonym #xsd/langString "average life@en",
   :db/ident :fibo-sec-dbt-pbs/WeightedAverageLife,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "weighted average life@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
                     {:owl/minQualifiedCardinality #xsd/nonNegativeInteger 0,
...
(def WeightedAverageLoanAge
  ...
  {:cmns-av/abbreviation #xsd/langString "WALA@en",
   :cmns-av/explanatoryNote
   [#xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "weighted average loan age@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
                     :fibo-fnd-utl-alx/ArithmeticMean
                     :fibo-fnd-utl-alx/QualifiedMeasure
                     {:owl/minQualifiedCardinality #xsd/nonNegativeInteger 0,
...
(def WeightedAverageMaturity
  ...
  {:cmns-av/abbreviation #xsd/langString "WAM@en",
   :cmns-av/explanatoryNote
   [#xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "weighted average maturity@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
                     :fibo-fnd-utl-alx/ArithmeticMean
                     :fibo-fnd-utl-alx/QualifiedMeasure
                     {:owl/minQualifiedCardinality #xsd/nonNegativeInteger 0,
...
(def WeightedAverageRemainingTerm
  ...
  {:cmns-av/abbreviation #xsd/langString "WART@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   :cmns-av/synonym #xsd/langString "weighted average remaining maturity@en",
   :db/ident :fibo-sec-dbt-pbs/WeightedAverageRemainingTerm,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "weighted average remaining term@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure
                     :fibo-fnd-utl-alx/ArithmeticMean
                     :fibo-fnd-utl-alx/QualifiedMeasure
                     {:owl/minQualifiedCardinality #xsd/nonNegativeInteger 0,
...
(def isPassThrough
  ...
  {:db/ident :fibo-sec-dbt-pbs/isPassThrough,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/PoolBackedSecurities/"},
   :rdfs/label #xsd/langString "is pass through@en",
