  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/subClassOf #{:fibo-md-dbtx-aly/YieldCalculationMethod
                      {:owl/onProperty     :cmns-qtu/hasArgument,
                       :owl/someValuesFrom :fibo-fbc-fi-ip/CleanPrice,
                       :rdf/type           :owl/Restriction}},
   :skos/definition
   {:rdf/language "en",
...
(def EquivalentLifeAnalytic
  {:db/ident :fibo-md-dbtx-aly/EquivalentLifeAnalytic,
   ...
   #{{:owl/onProperty     :cmns-doc/refersTo,
      ...
      :rdf/type           :owl/Restriction} :fibo-md-dbtx-aly/LifeAnalytic
     {:owl/onProperty     :fibo-fbc-dae-dbt/isBasedOn,
...
(def SimpleYieldCalculationMethod
  {:cmns-av/explanatoryNote
   ...
   :rdfs/subClassOf #{:fibo-md-dbtx-aly/YieldCalculationMethod
                      {:owl/onProperty     :cmns-qtu/hasArgument,
                       :owl/someValuesFrom :fibo-fbc-fi-ip/DirtyPrice,
                       :rdf/type           :owl/Restriction}},
   :skos/definition
   {:rdf/language "en",
    :rdf/value
...
(def YieldCalculationMethod
  {:db/ident :fibo-md-dbtx-aly/YieldCalculationMethod,
   ...
   :rdfs/subClassOf
   #{{:owl/allValuesFrom :cmns-qtu/Variable,
      :owl/onProperty    :cmns-qtu/hasArgument,
      :rdf/type          :owl/Restriction}
     {:owl/onProperty     :fibo-fnd-utl-alx/hasFormula,
