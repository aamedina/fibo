(ns net.wikipunk.rdf.fibo-md-dbtx-aly
  ...
  {:cmns-av/copyright "Copyright (c) 2013-2023 EDM Council, Inc.",
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/",
   :rdfs/label #xsd/langString "Debt Analytics Ontology@en"})
...
(def AccruedInterestAmount
  ...
  {:db/ident :fibo-md-dbtx-aly/AccruedInterestAmount,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "accrued interest amount@en",
...
(def BondEquivalentYield
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "bond equivalent yield@en",
   :rdfs/subClassOf
...
(def CashStructuredFinanceInstrumentPrice
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "cash structured finance instrument price@en",
...
(def CleanPrice
  ...
  {:db/ident :fibo-md-dbtx-aly/CleanPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "clean price@en",
   :rdfs/subClassOf :fibo-fbc-fi-ip/SecurityPrice,
   :skos/definition
   #xsd/langString
...
(def CollectionOfDebtPools
  ...
  {:db/ident :fibo-md-dbtx-aly/CollectionOfDebtPools,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "collection of debt pools@en",
   ...
   :skos/definition
   #xsd/langString
    "pool consisting of one or more pools of debt instrument(s)@en"})
...
(def CreditSpread
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "credit spread@en",
...
(def CurrentYieldCalculationMethod
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "current yield calculation method@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasArgument,
   ...
   :skos/definition
   #xsd/langString
    "The ratio of the interest payment amount to the clean price.@en"})
...
(def DebtConvexityAnalytic
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtConvexityAnalytic,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt convexity analytic@en",
...
(def DebtInstrumentYield
  ...
  {:cmns-av/explanatoryNote #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt instrument yield@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
     :owl/someValuesFrom {:owl/unionOf
                          [:fibo-md-dbtx-aly/LifeAnalytic
    ...
    :fibo-fbc-fi-ip/Yield],
   :skos/definition
   #xsd/langString "The return on the debt instrument at the stated price.@en"})
...
(def DebtPriceSpread
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtPriceSpread,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt price spread@en",
...
(def DebtSecuritiesMarketMaker
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtSecuritiesMarketMaker,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt securities market maker@en",
...
(def DebtYieldToAverageLife
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtYieldToAverageLife,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt yield to average life@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
...
(def DebtYieldToEquivalentLife
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtYieldToEquivalentLife,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt yield to equivalent life@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
...
(def DebtYieldToMaturity
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtYieldToMaturity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt yield to maturity@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
...
(def DebtYieldToNextCall
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtYieldToNextCall,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt yield to next call@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
...
(def DebtYieldToWorst
  ...
  {:db/ident :fibo-md-dbtx-aly/DebtYieldToWorst,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "debt yield to worst@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
...
(def DerivedPrice
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "derived price@en",
   :rdfs/subClassOf :fibo-fbc-fi-ip/SecurityPrice,
   :skos/definition
   #xsd/langString
...
(def DirtyPrice
  ...
  {:db/ident :fibo-md-dbtx-aly/DirtyPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "dirty price@en",
...
(def DiscountedInstrumentYield
  ...
  {:cmns-av/usageNote #xsd/langString "Applies to Debt only.@en",
   :db/ident :fibo-md-dbtx-aly/DiscountedInstrumentYield,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "discounted instrument yield@en",
   :rdfs/subClassOf
   [:fibo-md-dbtx-aly/DebtInstrumentYield
    {:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
     :owl/someValuesFrom {:owl/unionOf
...
(def DurationAnalytic
  ...
  {:db/ident :fibo-md-dbtx-aly/DurationAnalytic,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "duration analytic@en",
...
(def EffectiveDuration
  ...
  {:db/ident :fibo-md-dbtx-aly/EffectiveDuration,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "effective duration@en",
...
(def EffectiveYield
  ...
  {:db/ident :fibo-md-dbtx-aly/EffectiveYield,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "effective yield@en",
   :rdfs/subClassOf
   [:fibo-md-dbtx-aly/DebtInstrumentYield
    {:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
     :owl/someValuesFrom {:owl/unionOf
...
(def EquivalentLifeAnalytic
  ...
  {:db/ident :fibo-md-dbtx-aly/EquivalentLifeAnalytic,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "equivalent life analytic@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-rel-rel/refersTo,
...
(def EquivalentYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/EquivalentYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "equivalent yield calculation method@en",
...
(def ExchangeTradedBondPrice
  ...
  {:db/ident :fibo-md-dbtx-aly/ExchangeTradedBondPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "exchange traded bond price@en",
   :rdfs/subClassOf :fibo-fbc-fi-ip/SecurityPrice})
...
(def FFIECDown300PrepaySpeed
  ...
  {:db/ident :fibo-md-dbtx-aly/FFIECDown300PrepaySpeed,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "f f i e c down 300 prepay speed@en",
...
(def FFIECUp300PrepaySpeed
  ...
  {:db/ident :fibo-md-dbtx-aly/FFIECUp300PrepaySpeed,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "f f i e c up 300 prepay speed@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/PrepaymentSpeed
                     {:owl/onProperty :fibo-fbc-dae-dbt/isBasedOn,
                      :owl/someValuesFrom
                      :fibo-md-dbtx-aly/LoanPoolPrepaymentModel,
...
(def ICMAYieldFormula
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "i c m a yield formula@en",
...
(def ImpliedForwardRate
  ...
  {:db/ident :fibo-md-dbtx-aly/ImpliedForwardRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "implied forward rate@en",
...
(def InternallyDeterminedPriceSpread
  ...
  {:db/ident :fibo-md-dbtx-aly/InternallyDeterminedPriceSpread,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "internally determined price spread@en",
...
(def InterpolatedPrice
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "interpolated price@en",
...
(def JapaneseCompoundYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/JapaneseCompoundYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "japanese compound yield calculation method@en",
   :rdfs/subClassOf [:fibo-md-dbtx-aly/YieldCalculationMethod
                     ...
                     {:owl/allValuesFrom :fibo-fnd-utl-alx/Variable,
                      ...
                      :rdf/type          :owl/Restriction}
                     :fibo-fnd-utl-alx/Formula],
   :skos/definition #xsd/langString "No definition in selection list.@en"})
...
(def JapaneseSimpleYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/JapaneseSimpleYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "japanese simple yield calculation method@en",
   :rdfs/subClassOf [:fibo-md-dbtx-aly/YieldCalculationMethod
                     {:owl/allValuesFrom :fibo-fnd-dt-fd/RecurrenceInterval,
                      :owl/onProperty :fibo-fbc-dae-dbt/hasCompoundingFrequency,
                      :rdf/type :owl/Restriction}
...
(def KeyRateDuration
  ...
  {:db/ident :fibo-md-dbtx-aly/KeyRateDuration,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "key rate duration@en",
   :rdfs/subClassOf [:fibo-md-dbtx-aly/DurationAnalytic
                     {:owl/onProperty     :fibo-fnd-rel-rel/refersTo,
                      :owl/someValuesFrom :fibo-md-dbtx-aly/DebtInstrumentYield,
                      :rdf/type           :owl/Restriction}
...
(def LifeAnalytic
  ...
  {:db/ident :fibo-md-dbtx-aly/LifeAnalytic,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "life analytic@en",
...
(def LoanPoolPrepaymentModel
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "loan pool prepayment model@en",
   :rdfs/subClassOf [{:owl/onProperty :cmns-col/comprises,
                      :owl/someValuesFrom
...
(def LoanPrepaymentFormula
  ...
  {:db/ident :fibo-md-dbtx-aly/LoanPrepaymentFormula,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "loan prepayment formula@en",
...
(def MacCaulaysDurationAnalytic
  ...
  {:db/ident :fibo-md-dbtx-aly/MacCaulaysDurationAnalytic,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "MacCaulays Duration Analytic@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-rel-rel/refersTo,
...
(def MaturityEquivalentPSA
  ...
  {:db/ident :fibo-md-dbtx-aly/MaturityEquivalentPSA,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "maturity equivalent p s a@en",
   :rdfs/subClassOf [:fibo-sec-dbt-pbs/PrepaymentSpeed
                     {:owl/onProperty :fibo-fbc-dae-dbt/isBasedOn,
                      :owl/someValuesFrom
                      :fibo-md-dbtx-aly/LoanPoolPrepaymentModel,
...
(def ModifiedDurationAnalytic
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "modified duration analytic@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fnd-rel-rel/refersTo,
                      :owl/someValuesFrom
...
(def NativeYield
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "native yield@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-fbc-dae-dbt/isBasedOn,
...
(def NativeYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/NativeYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "native yield calculation method@en",
   :rdfs/subClassOf
   ...
   :skos/definition
   #xsd/langString
    "The convention used in the marketplace for that security.@en"})
...
(def NextCall
  ...
  {:db/ident :fibo-md-dbtx-aly/NextCall,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "next call@en",
...
(def NextCallDate
  ...
  {:db/ident :fibo-md-dbtx-aly/NextCallDate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "next call date@en",
...
(def NextPut
  ...
  {:db/ident :fibo-md-dbtx-aly/NextPut,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "next put@en",
...
(def OTCBondMarketPrice
  ...
  {:db/ident :fibo-md-dbtx-aly/OTCBondMarketPrice,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "o t c bond market price@en",
...
(def OptionAdjustedYield
  ...
  {:db/ident :fibo-md-dbtx-aly/OptionAdjustedYield,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "option adjusted yield@en",
   :rdfs/subClassOf
   [:fibo-md-dbtx-aly/DebtInstrumentYield
    {:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
     :owl/someValuesFrom {:owl/unionOf
...
(def PartialCallsEstimationModel
  ...
  {:db/ident :fibo-md-dbtx-aly/PartialCallsEstimationModel,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "partial calls estimation model@en",
   :rdfs/subClassOf :fibo-fnd-utl-alx/Formula,
   :skos/definition
   #xsd/langString "A model of how the early partial calls are estimated.@en"})
...
(def PoolFactor
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "pool factor@en",
...
(def PoolPaydownRate
  ...
  {:db/ident :fibo-md-dbtx-aly/PoolPaydownRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "pool paydown rate@en",
...
(def PriceValueOfBasisPoint
  ...
  {:cmns-av/abbreviation #xsd/langString "PVBP@en",
   :cmns-av/explanatoryNote
   #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "price value of basis point@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-rel-rel/refersTo,
                      :owl/someValuesFrom :fibo-md-dbtx-aly/DebtInstrumentYield,
                      :rdf/type           :owl/Restriction}
                     :fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure],
...
(def RelativeYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/RelativeYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "relative yield calculation method@en",
   :rdfs/subClassOf [:fibo-md-dbtx-aly/YieldCalculationMethod
                     {:owl/allValuesFrom :fibo-fnd-dt-fd/RecurrenceInterval,
                      :owl/onProperty :fibo-fbc-dae-dbt/hasCompoundingFrequency,
                      :rdf/type :owl/Restriction}
...
(def RelativelyDefinedDebtInstrumentYield
  ...
  {:db/ident :fibo-md-dbtx-aly/RelativelyDefinedDebtInstrumentYield,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "relatively defined debt instrument yield@en",
   :rdfs/subClassOf
   [:fibo-md-dbtx-aly/DebtInstrumentYield
    {:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
     :owl/someValuesFrom {:owl/unionOf
...
(def RussianYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/RussianYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "russian yield calculation method@en",
...
(def RussianYieldFormula
  ...
  {:db/ident :fibo-md-dbtx-aly/RussianYieldFormula,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "russian yield formula@en",
   :rdfs/subClassOf [:fibo-md-dbtx-aly/YieldCalculationFormula
                     {:owl/onProperty     :cmns-cxtdsg/appliesTo,
                      :owl/someValuesFrom :fibo-md-dbtx-aly/DebtInstrumentYield,
                      :rdf/type           :owl/Restriction}
...
(def SimpleYieldCalculationMethod
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "simple yield calculation method@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasArgument,
...
(def SpanishYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/SpanishYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "spanish yield calculation method@en",
   :rdfs/subClassOf [:fibo-md-dbtx-aly/YieldCalculationMethod
                     {:owl/allValuesFrom :fibo-fnd-dt-fd/RecurrenceInterval,
                      :owl/onProperty :fibo-fbc-dae-dbt/hasCompoundingFrequency,
                      :rdf/type :owl/Restriction}
...
(def USCorporateBondYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/USCorporateBondYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "u s corporate bond yield calculation method@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasFormula,
...
(def USTreasuryYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/USTreasuryYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "u s treasury yield calculation method@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasFormula,
                      :owl/someValuesFrom :fibo-md-dbtx-aly/ICMAYieldFormula,
                      :rdf/type           :owl/Restriction}
                     :fibo-md-dbtx-aly/YieldCalculationMethod
...
(def WallStreetYieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/WallStreetYieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "wall street yield calculation method@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-utl-alx/hasFormula,
                      :owl/someValuesFrom :fibo-md-dbtx-aly/ICMAYieldFormula,
                      :rdf/type           :owl/Restriction}
                     :fibo-md-dbtx-aly/YieldCalculationMethod
                     ...
                     :fibo-fnd-utl-alx/Formula],
   :skos/definition #xsd/langString
                     "No definition.Term put here from memory.@en"})
...
(def WeightedAverageTimeToReceiptOfCashflows
  ...
  {:db/ident :fibo-md-dbtx-aly/WeightedAverageTimeToReceiptOfCashflows,
   ...
   :rdfs/label #xsd/langString
                "weighted average time to receipt of cashflows@en",
   :rdfs/subClassOf :fibo-fnd-utl-alx/Formula,
   :skos/definition
   #xsd/langString
...
(def WorstCall
  ...
  {:db/ident :fibo-md-dbtx-aly/WorstCall,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "worst call@en",
...
(def YieldCalculationFormula
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "yield calculation formula@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cxtdsg/appliesTo,
                      :owl/someValuesFrom :fibo-md-dbtx-aly/DebtInstrumentYield,
                      :rdf/type           :owl/Restriction}
                     :fibo-fnd-utl-alx/Formula],
   :skos/definition #xsd/langString
                     "The formula used in determining the Yield.@en"})
...
(def YieldCalculationMethod
  ...
  {:db/ident :fibo-md-dbtx-aly/YieldCalculationMethod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "yield calculation method@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fnd-utl-alx/hasFormula,
                      :owl/someValuesFrom
                      :fibo-md-dbtx-aly/YieldCalculationFormula,
                      :rdf/type :owl/Restriction}
...
(def YieldToNextPut
  ...
  {:db/ident :fibo-md-dbtx-aly/YieldToNextPut,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "yield to next put@en",
   :rdfs/subClassOf
   [{:owl/onProperty     :fibo-md-dbtx-aly/hasOutlookPeriod,
...
(def calculationFollowing
  ...
  {:db/ident :fibo-md-dbtx-aly/calculationFollowing,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "calculation following@en",
...
(def daysAccrued
  ...
  {:db/ident :fibo-md-dbtx-aly/daysAccrued,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "days accrued@en",
...
(def decimalPlaces
  ...
  {:db/ident :fibo-md-dbtx-aly/decimalPlaces,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "decimal places@en",
   :rdfs/range :xsd/integer,
   :skos/definition
   #xsd/langString
...
(def defaultRateValue
  ...
  {:db/ident :fibo-md-dbtx-aly/defaultRateValue,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "default rate value@en",
...
(def determinesMarketPriceForDebt
  ...
  {:db/ident :fibo-md-dbtx-aly/determinesMarketPriceForDebt,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "determines market price for debt@en",
...
(def equivalentLifeValue
  ...
  {:db/ident :fibo-md-dbtx-aly/equivalentLifeValue,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "equivalent life value@en",
...
(def hasAnalytic
  ...
  {:db/ident :fibo-md-dbtx-aly/hasAnalytic,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has analytic@en",
...
(def hasDefaultRate
  ...
  {:db/ident :fibo-md-dbtx-aly/hasDefaultRate,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has default rate@en",
...
(def hasFactor
  ...
  {:db/ident :fibo-md-dbtx-aly/hasFactor,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has factor@en",
...
(def hasMeasure
  ...
  {:db/ident :fibo-md-dbtx-aly/hasMeasure,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has measure@en",
...
(def hasOutlookPeriod
  ...
  {:db/ident :fibo-md-dbtx-aly/hasOutlookPeriod,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has outlook period@en",
...
(def hasWac
  ...
  {:db/ident :fibo-md-dbtx-aly/hasWac,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has wac@en",
...
(def hasYield
  ...
  {:db/ident :fibo-md-dbtx-aly/hasYield,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "has yield@en",
...
(def isAggregateOf
  ...
  {:db/ident :fibo-md-dbtx-aly/isAggregateOf,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "is aggregate of@en",
   :rdfs/range :fibo-sec-dbt-pbs/DebtPoolStatisticalMeasure})
...
(def isCompounded
  ...
  {:db/ident :fibo-md-dbtx-aly/isCompounded,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "is compounded@en",
...
(def isDefaultMethodFor
  ...
  {:db/ident :fibo-md-dbtx-aly/isDefaultMethodFor,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "is default method for@en",
...
(def isRateOfChangeOf
  ...
  {:db/ident :fibo-md-dbtx-aly/isRateOfChangeOf,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "is rate of change of@en",
...
(def modifiedDurationValue
  ...
  {:db/ident :fibo-md-dbtx-aly/modifiedDurationValue,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "modified duration value@en",
   :rdfs/range :cmns-dt/Duration,
   :skos/definition #xsd/langString "The Modified Duration in Years.@en"})
...
(def priceIsTraded
  ...
  {:db/ident :fibo-md-dbtx-aly/priceIsTraded,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "price is traded@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
...
(def priceQuotedExDividend
  ...
  {:db/ident :fibo-md-dbtx-aly/priceQuotedExDividend,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "price quoted ex dividend@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
...
(def quotedExDividend
  ...
  {:db/ident :fibo-md-dbtx-aly/quotedExDividend,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "quoted ex dividend@en",
   :rdfs/range :xsd/boolean,
   :skos/definition
   #xsd/langString
    "Whether or not the price is quoted ex-dividend. When a bond is said to trade ex-dividend it means that there is a period of time prior to each coupon payment during which a bond purchaser does not receive custody of the next coupon. That payment is made to the previous bond holder and accrued interest is therefore negative during the ex-dividend period.@en"})
...
(def roundingConvention
  ...
  {:db/ident :fibo-md-dbtx-aly/roundingConvention,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/MD/DebtTemporal/DebtAnalytics/"},
   :rdfs/label #xsd/langString "rounding convention@en",
   :rdfs/range :xsd/string,
   :skos/definition
   #xsd/langString
    "The rounding convention used in the calculation method.@en"})