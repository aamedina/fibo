(ns net.wikipunk.rdf.fibo-loan-reln-mtg
  ...
  {:cmns-av/copyright ["Copyright (c) 2016-2023 Object Management Group, Inc."
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/",
   :rdfs/label #xsd/langString "Mortgage Loans Ontology@en"})
...
(def GovernmentSponsoredLoan
  ...
  {:db/ident :fibo-loan-reln-mtg/GovernmentSponsoredLoan,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/"},
   :rdfs/label #xsd/langString "government-sponsored loan@en",
   :rdfs/subClassOf
...
(def ManufacturedHomeLegalClassification
  ...
  {:cmns-av/adaptedFrom {:xsd/string "2015 Revised HMDA regulation"},
...
(def Mortgage
  ...
  {:cmns-av/adaptedFrom {:xsd/string
...
(def MortgageIndemnityGuarantee
  ...
  {:db/ident :fibo-loan-reln-mtg/MortgageIndemnityGuarantee,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/"},
   :rdfs/label #xsd/langString "mortgage indemnity guarantee@en",
   :rdfs/subClassOf
...
(def MortgageIndemnityGuarantor
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/"},
   :rdfs/label #xsd/langString "mortgage indemnity guarantor@en",
...
(def MortgageIndemnityInsurancePolicy
  ...
  {:db/ident :fibo-loan-reln-mtg/MortgageIndemnityInsurancePolicy,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/"},
   :rdfs/label #xsd/langString "mortgage indemnity insurance policy@en",
   ...
   :skos/definition
   #xsd/langString
    "insurance policy providing the mortgage indemnity guarantee@en"})
...
(def ReverseMortgage
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/"},
   :rdfs/label ["reverse mortgage" #xsd/langString "reverse mortgage@en"],
   :rdfs/subClassOf
...
(def isARMConvertible
  ...
  {:db/ident :fibo-loan-reln-mtg/isARMConvertible,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/LOAN/RealEstateLoans/MortgageLoans/"},
   :rdfs/label #xsd/langString "is ARM convertible@en",
