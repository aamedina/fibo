(ns net.wikipunk.rdf.gleif-base
  ...
  {:dcat/downloadURL "https://www.gleif.org/ontology/v1.0/Base/ontology.ttl",
   ...
   :rdfs/label #voc/lstr "GLEIF Base Ontology@en",
...
(def GLEIF
  ...
  {:db/ident           :gleif-base/GLEIF,
   ...
   :gleif-base/hasName #voc/lstr "Global Legal Entity Identifier Foundation@en",
   :gleif-base/hasNameLegal #voc/lstr
                             "Global Legal Entity Identifier Foundation@en",
   :gleif-base/hasNameLegalLocal
   #voc/lstr "Global Legal Entity Identifier Foundation@en",
   :gleif-base/hasNameLocal #voc/lstr
                             "Global Legal Entity Identifier Foundation@en",
   :rdf/type           [:gleif-base/RegistrationAuthority
                        ...
                        :gleif-base/Entity],
   :rdfs/isDefinedBy   "https://www.gleif.org/ontology/Base/",
   :rdfs/label         #voc/lstr "Global Legal Entity Identifier Foundation@en",
   :skos/prefLabel     #voc/lstr
                        "Global Legal Entity Identifier Foundation@en"})
