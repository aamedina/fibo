(ns net.wikipunk.rdf.gleif-base
  ...
  {:dcat/downloadURL "https://www.gleif.org/ontology/v1.0/Base/ontology.ttl",
   ...
   :dcterms/title #xsd/langString
                   "Global Legal Entity Identifier Foundation Base Ontology@en",
   :owl/imports
   {:rdfa/uri "https://www.omg.org/spec/LCC/Countries/CountryRepresentation/"},
   :owl/versionIRI {:rdfa/uri "https://www.gleif.org/ontology/Base-v1.0/Base/"},
   :rdf/ns-prefix-map
   ...
   :rdfs/label #xsd/langString "GLEIF Base Ontology@en",
...
(def Entity
  ...
  {:db/ident :gleif-base/Entity,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy {:rdfa/uri "https://www.gleif.org/ontology/Base/"},
   :rdfs/label "entity",
...
(def EntityExpirationReasonCorporateAction
  ...
  {:db/ident          :gleif-base/EntityExpirationReasonCorporateAction,
   ...
   :skos/notation     "CORPORATE_ACTION"})
...
(def EntityStatusActive
  ...
  {:db/ident :gleif-base/EntityStatusActive,
   ...
   :rdf/type [:gleif-base/EntityStatus :owl/NamedIndividual],
   :rdfs/isDefinedBy {:rdfa/uri "https://www.gleif.org/ontology/Base/"},
   :rdfs/label "active",
   :skos/definition
...
(def GLEIF
  ...
  {:db/ident           :gleif-base/GLEIF,
   ...
   :gleif-base/hasName #xsd/langString
                        "Global Legal Entity Identifier Foundation@en",
   :gleif-base/hasNameLegal #xsd/langString
                             "Global Legal Entity Identifier Foundation@en",
   :gleif-base/hasNameLegalLocal
   #xsd/langString "Global Legal Entity Identifier Foundation@en",
...
(def Period
  ...
  {:db/ident :gleif-base/Period,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy {:rdfa/uri "https://www.gleif.org/ontology/Base/"},
   :rdfs/label #xsd/langString "period@en",
   :rdfs/subClassOf [{:owl/onDataRange :xsd/dateTime,
...
(def hasAbbreviationLocal
  ...
  {:db/ident :gleif-base/hasAbbreviationLocal,
   ...
   :rdfs/subPropertyOf [:gleif-base/hasAbbreviation :skos/altLabel],
   :skos/definition
...
(def hasNameASCIIAutomatic
  ...
  {:db/ident :gleif-base/hasNameASCIIAutomatic,
   ...
   :rdfs/subPropertyOf [:gleif-base/hasNameLegal
...
(def hasNameAdditional
  ...
  {:db/ident :gleif-base/hasNameAdditional,
   ...
   :rdfs/subPropertyOf [:gleif-base/hasName :skos/altLabel :rdfs/label],
...
(def hasNameAdditionalLocal
  ...
  {:db/ident :gleif-base/hasNameAdditionalLocal,
   ...
   :rdfs/subPropertyOf [:gleif-base/hasNameLocal
...
(def hasNameLegal
  ...
  {:db/ident :gleif-base/hasNameLegal,
   ...
   :rdfs/subPropertyOf [:gleif-base/hasName :rdfs/label],
