(ns net.wikipunk.rdf.fibo-cae-ce-srca
  ...
  {:cmns-av/copyright "Copyright (c) 2016-2023 EDM Council, Inc.",
   ...
   :rdfs/label #xsd/langString
                "Security-related Corporate Actions Ontology@en"})
...
(def BondDefaultAction
  ...
  {:db/ident :fibo-cae-ce-srca/BondDefaultAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "bond default event@en",
...
(def BonusIssue
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym [#xsd/langString "scrip issue@en"
                     #xsd/langString "capitalisation issue@en"],
   :db/ident :fibo-cae-ce-srca/BonusIssue,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "bonus issue@en",
...
(def BonusRightsIssue
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "bonus rights issue@en",
...
(def BonusSharePlanDistribution
  ...
  {:db/ident :fibo-cae-ce-srca/BonusSharePlanDistribution,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "bonus share plan distribution@en",
...
(def CallOnIntermediateSecurities
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "call on intermediate securities@en",
...
(def CancellationOfShares
  ...
  {:db/ident :fibo-cae-ce-srca/CancellationOfShares,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "cancellation of shares@en",
...
(def CapitalDistribution
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "capital distribution@en",
...
(def CapitalGainsDistribution
  ...
  {:db/ident :fibo-cae-ce-srca/CapitalGainsDistribution,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "capital gains distribution@en",
   :rdfs/subClassOf :fibo-cae-ce-act/VoluntaryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def CashDividendAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "cash dividend action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def ChangeOfSecurityTradingStatusEvent
  ...
  {:db/ident :fibo-cae-ce-srca/ChangeOfSecurityTradingStatusEvent,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "change of security trading status event@en",
   :rdfs/subClassOf [{:owl/onProperty :cmns-cxtdsg/appliesTo,
                      :owl/someValuesFrom
...
(def ChangeToSmallestNegotiableUnit
  ...
  {:db/ident :fibo-cae-ce-srca/ChangeToSmallestNegotiableUnit,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "change to smallest negotiable unit@en",
   :rdfs/subClassOf :fibo-cae-ce-act/CorporateAction,
   :skos/definition
   #xsd/langString
...
(def ConversionAction
  ...
  {:db/ident :fibo-cae-ce-srca/ConversionAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "conversion action@en",
...
(def ConversionSuspensionAction
  ...
  {:db/ident :fibo-cae-ce-srca/ConversionSuspensionAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "conversion suspension action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/CorporateAction,
   :skos/definition
   #xsd/langString
...
(def CorporateActionObligation
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "corporate action obligation@en",
...
(def CorporateActionPaymentObligation
  ...
  {:db/ident :fibo-cae-ce-srca/CorporateActionPaymentObligation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "corporate action payment obligation@en",
...
(def CorporateActionSecuritiesDeliveryObligation
  ...
  {:db/ident :fibo-cae-ce-srca/CorporateActionSecuritiesDeliveryObligation,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString
                "corporate action securities delivery obligation@en",
   :rdfs/subClassOf [:fibo-cae-ce-srca/CorporateActionObligation
                     :fibo-fnd-law-lcap/Duty
                     :fibo-cae-ce-act/CorporateAction],
   :skos/definition
...
(def CorporateChangeOfStatusEvent
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "corporate change of status event@en",
   :rdfs/subClassOf [:fibo-fnd-arr-lif/LifecycleEvent
                     :fibo-cae-ce-act/CorporateAction],
   :skos/definition #xsd/langString
                     "Some change to the status of some security.@en"})
...
(def CouponStrip
  ...
  {:db/ident :fibo-cae-ce-srca/CouponStrip,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "coupon strip@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cxtdsg/appliesTo,
                      :owl/someValuesFrom :fibo-sec-dbt-bnd/Bond,
                      :rdf/type           :owl/Restriction}
                     :fibo-cae-ce-act/CorporateAction],
...
(def DecreaseInValueAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "decrease in value action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def DividendOptionAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "dividend option action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryWithChoiceCorporateAction,
   :skos/definition
   #xsd/langString
...
(def DividendReinvestmentAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "dividend reinvestment action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryWithChoiceCorporateAction,
   :skos/definition
   #xsd/langString
...
(def Drawing
  ...
  {:cmns-av/explanatoryNote #xsd/langString
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "drawing@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def DutchAuction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "dutch auction@en",
   :rdfs/subClassOf :fibo-cae-ce-act/VoluntaryCorporateAction,
   :skos/definition
   #xsd/langString
    "corporate action by a party wishing to acquire a security@en"})
...
(def ExchangeAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "exchange action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/CorporateAction,
   :skos/definition
   #xsd/langString
...
(def FormalOffer
  ...
  {:db/ident :fibo-cae-ce-srca/FormalOffer,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "formal offer@en",
   :rdfs/subClassOf :fibo-cae-ce-act/VoluntaryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def FullCallEarlyRedemptionAction
  ...
  {:db/ident :fibo-cae-ce-srca/FullCallEarlyRedemptionAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "full call early redemption action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def InterestPaymentAction
  ...
  {:db/ident :fibo-cae-ce-srca/InterestPaymentAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "interest payment action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def InterestPaymentInKind
  ...
  {:db/ident :fibo-cae-ce-srca/InterestPaymentInKind,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "interest payment in kind@en",
...
(def InterestPaymentWithPrincipal
  ...
  {:db/ident :fibo-cae-ce-srca/InterestPaymentWithPrincipal,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "interest payment with principal@en",
   :rdfs/subClassOf [:fibo-cae-ce-srca/InterestPaymentAction
                     :fibo-cae-ce-act/MandatoryCorporateAction],
   :skos/definition
   #xsd/langString
...
(def InterestRateAdjustment
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "interest rate adjustment@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cxtdsg/appliesTo,
...
(def IntermediateSecuritiesDistribution
  ...
  {:cmns-av/synonym #xsd/langString "rights distribution@en",
   :db/ident :fibo-cae-ce-srca/IntermediateSecuritiesDistribution,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "intermediate securities distribution@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def ListingStatusDelistingMessage
  ...
  {:db/ident :fibo-cae-ce-srca/ListingStatusDelistingMessage,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "listing status delisting message@en",
...
(def OddLotOffer
  ...
  {:db/ident :fibo-cae-ce-srca/OddLotOffer,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "odd lot offer@en",
   :rdfs/subClassOf :fibo-cae-ce-act/VoluntaryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def PariPassuAction
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym #xsd/langString "assimilation@en",
   :db/ident :fibo-cae-ce-srca/PariPassuAction,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "pari-passu action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def PartialRedemptionWithoutReductionOfNominalValueAction
  ...
  {:cmns-av/explanatoryNote
   ...
   :rdfs/label
   #xsd/langString
    "partial redemption without reduction of nominal value action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/CorporateAction,
   :skos/definition
   #xsd/langString
...
(def PostMergerSecuritiesExchange
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "post-merger securities exchange@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-cae-ce-srca/convertsTo,
                      :owl/someValuesFrom :fibo-fbc-fi-fi/Security,
                      :rdf/type           :owl/Restriction}
                     {:owl/onProperty     :fibo-cae-ce-srca/convertsFrom,
...
(def PutRedemptionAction
  ...
  {:db/ident :fibo-cae-ce-srca/PutRedemptionAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "put redemption action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/VoluntaryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def RedemptionAtMaturityAction
  ...
  {:db/ident :fibo-cae-ce-srca/RedemptionAtMaturityAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "redemption at maturity action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def RedenominationAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "redenomination action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def RepurchaseOffer
  ...
  {:cmns-av/explanatoryNote
   ...
   :cmns-av/synonym [#xsd/langString "reverse rights@en"
                     #xsd/langString "issuer bid@en"],
   :db/ident :fibo-cae-ce-srca/RepurchaseOffer,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "repurchase offer@en",
   :rdfs/subClassOf :fibo-cae-ce-act/VoluntaryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def ReverseStockSplit
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString
    "Equity price and nominal value are increased accordingly.@en",
   :cmns-av/synonym #xsd/langString "change in nominal value@en",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "reverse stock split@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cxtdsg/appliesTo,
...
(def RightsExerciseEvent
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "rights exercise event@en",
   :rdfs/subClassOf :fibo-cae-ce-act/CorporateAction,
   :skos/definition
   #xsd/langString
...
(def SharesPremiumDividendAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "shares premium dividend action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryWithChoiceCorporateAction,
   :skos/definition
   #xsd/langString
...
(def StockDividendAction
  ...
  {:db/ident :fibo-cae-ce-srca/StockDividendAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "stock dividend action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def StockSplit
  ...
  {:cmns-av/explanatoryNote
   #xsd/langString "Equity price and nominal value are reduced accordingly.@en",
   :cmns-av/synonym [#xsd/langString "subdivision@en"
                     #xsd/langString "change in nominal value@en"],
   :db/ident :fibo-cae-ce-srca/StockSplit,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "stock split@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-cxtdsg/appliesTo,
                      :owl/someValuesFrom :fibo-sec-eq-eq/Share,
                      :rdf/type           :owl/Restriction}
                     :fibo-cae-ce-act/MandatoryCorporateAction],
...
(def TenderOffer
  ...
  {:cmns-av/synonym [#xsd/langString "buyback@en"
                     #xsd/langString "purchase offer@en"
                     #xsd/langString "acquisition@en"
                     #xsd/langString "takeover@en"],
   :db/ident :fibo-cae-ce-srca/TenderOffer,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "tender offer@en",
   :rdfs/subClassOf [:fibo-cae-ce-act/VoluntaryCorporateAction
...
(def TradingStatusActiveMessage
  ...
  {:db/ident :fibo-cae-ce-srca/TradingStatusActiveMessage,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "trading status active message@en",
...
(def TradingStatusMessage
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "trading status message@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fnd-rel-rel/refersTo,
                     ...
                     {:owl/onProperty :fibo-fnd-arr-doc/isAbout,
                      ...
                      :rdf/type :owl/Restriction}
                     :fibo-fnd-arr-doc/Notice],
   :skos/definition #xsd/langString "A message about trading status.@en"})
...
(def TradingStatusSuspendedMessage
  ...
  {:db/ident :fibo-cae-ce-srca/TradingStatusSuspendedMessage,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "trading status suspended message@en",
   :rdfs/subClassOf [:fibo-cae-ce-srca/TradingStatusMessage
                     {:owl/onProperty     :fibo-fnd-rel-rel/refersTo,
                      :owl/someValuesFrom :fibo-fbc-fi-fi/Security,
                      :rdf/type           :owl/Restriction}
                     ...
                     :fibo-fnd-arr-doc/Notice],
   :skos/definition #xsd/langString
                     "Trading in the security has been suspended.@en"})
...
(def WarrantExerciseAction
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "warrant exercise action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/CorporateAction,
   :skos/definition
   #xsd/langString
...
(def WorthlessSecurityAction
  ...
  {:db/ident :fibo-cae-ce-srca/WorthlessSecurityAction,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "worthless security action@en",
   :rdfs/subClassOf :fibo-cae-ce-act/MandatoryCorporateAction,
   :skos/definition
   #xsd/langString
...
(def convertsFrom
  ...
  {:db/ident :fibo-cae-ce-srca/convertsFrom,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "converts from@en",
...
(def convertsTo
  ...
  {:db/ident :fibo-cae-ce-srca/convertsTo,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/CAE/CorporateEvents/SecurityRelatedCorporateActions/"},
   :rdfs/label #xsd/langString "converts to@en",
   :rdfs/range :fibo-fbc-fi-fi/Security})