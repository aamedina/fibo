(ns net.wikipunk.rdf.fibo-sec-dbt-abs
  ...
  {:cmns-av/copyright "Copyright (c) 2015-2023 EDM Council, Inc.",
   ...
   :rdfa/uri
   "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/",
   :rdfs/label #xsd/langString "Asset-backed Securities Ontology@en"})
...
(def AutoAssetBackedSecurity
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "auto asset-backed security@en",
...
(def AutoDebtPool
  ...
  {:db/ident :fibo-sec-dbt-abs/AutoDebtPool,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "auto debt pool@en",
   ...
   :skos/definition #xsd/langString
                     "debt pool of auto-related loans or leases@en"})
...
(def BondPool
  ...
  {:db/ident :fibo-sec-dbt-abs/BondPool,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "bond pool@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/hasConstituent,
                      :owl/someValuesFrom :fibo-sec-dbt-bnd/Bond,
                      :rdf/type           :owl/Restriction}
                     :fibo-sec-sec-pls/DebtPool],
   :skos/definition #xsd/langString "debt pool of consisting of bonds@en"})
...
(def ConsumerAssetBackedSecurity
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "consumer asset-backed security@en",
...
(def CreditCardAssetBackedSecurity
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "credit card asset-backed security@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom :fibo-sec-dbt-abs/CreditCardPool,
                      :rdf/type           :owl/Restriction}
                     :fibo-sec-dbt-pbs/AssetBackedSecurity],
   :skos/definition
   #xsd/langString "asset-backed security based on credit card receivables@en"})
...
(def CreditCardPool
  ...
  {:cmns-av/adaptedFrom
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "credit card pool@en",
...
(def HomeEquityLineOfCreditPool
  ...
  {:db/ident :fibo-sec-dbt-abs/HomeEquityLineOfCreditPool,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "home equity line of credit pool@en",
   :rdfs/subClassOf [{:owl/onProperty :cmns-col/hasConstituent,
                      :owl/someValuesFrom
                     ...
                     :fibo-sec-sec-pls/DebtPool],
   :skos/definition #xsd/langString
                     "debt pool consisting of home equity loans@en"})
...
(def HomeEquityLoanAssetBackedSecurity
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "home equity loan asset-backed security@en",
   :rdfs/subClassOf [{:owl/onProperty :fibo-fbc-fi-fi/hasUnderlier,
                      :owl/someValuesFrom
   ...
   :skos/definition
   #xsd/langString
    "asset-backed security based on home equity loan receivables@en"})
...
(def StudentLoanAssetBackedSecurity
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "student loan asset-backed security@en",
   :rdfs/subClassOf [{:owl/onProperty     :fibo-fbc-fi-fi/hasUnderlier,
   ...
   :skos/definition
   #xsd/langString
    "asset-backed security based on student loan receivables@en"})
...
(def StudentLoanPool
  ...
  {:db/ident :fibo-sec-dbt-abs/StudentLoanPool,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/SEC/Debt/AssetBackedSecurities/"},
   :rdfs/label #xsd/langString "student loan pool@en",
   :rdfs/subClassOf [{:owl/onProperty     :cmns-col/hasConstituent,
                      :owl/someValuesFrom :fibo-loan-spc-stu/StudentLoan,
                      :rdf/type           :owl/Restriction}
                     :fibo-sec-sec-pls/DebtPool],
   :skos/definition #xsd/langString "debt pool consisting of student loans@en"})
