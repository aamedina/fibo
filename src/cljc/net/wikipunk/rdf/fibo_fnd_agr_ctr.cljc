(ns net.wikipunk.rdf.fibo-fnd-agr-ctr
  {:cmns-av/copyright
   ...
   #{"The https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts.rdf version of this ontology was revised as a part of the issue resolutions identified in the FIBO FND 1.1 RTF report to add a parent of hasDate to date properties."
     ...
     "The https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts.rdf version of the ontology was modified to better integrate the parties to a contract with the latest patterns (FBC-284)."
...
(def ContractualCommitment
  {:db/ident :fibo-fnd-agr-ctr/ContractualCommitment,
   ...
   #{{:owl/allValuesFrom :fibo-fnd-agr-ctr/ContractualCommitment,
      ...
      :rdf/type          :owl/Restriction} :fibo-fnd-agr-ctr/ContractualElement
     {:owl/onProperty     :fibo-fnd-rel-rel/isMandatedBy,
      :owl/someValuesFrom :fibo-fnd-agr-ctr/Contract,
      :rdf/type           :owl/Restriction} :fibo-fnd-agr-agr/MutualCommitment},
   :skos/definition
...
(def hasPrincipalParty
  {:db/ident :fibo-fnd-agr-ctr/hasPrincipalParty,
   ...
   :rdfs/subPropertyOf #{:fibo-fnd-agr-ctr/hasContractParty :cmns-pts/hasActor},
