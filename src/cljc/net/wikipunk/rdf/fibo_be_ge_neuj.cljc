...
(def AlandIslandsJurisdiction
  ...
  {:cmns-av/synonym #xsd/langString "Ålands tingsrätt@fi",
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Ålandöarnas jurisdiktion@sv"
                #xsd/langString "Aland Islands jurisdiction@en"
                #xsd/langString "Ahvenanmaan lainkäyttöalue@fi"],
...
(def AlandicEntity
  ...
  {:db/ident :fibo-be-ge-neuj/AlandicEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Ålandisk enhet@sv"
                #xsd/langString "Alandic entity@en"
                #xsd/langString "Ahvenanmaan kokonaisuus@fi"],
...
(def DanishEntity
  ...
  {:db/ident :fibo-be-ge-neuj/DanishEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Danish entity@en"
                #xsd/langString "Dansk enhed@da"],
...
(def EstonianEntity
  ...
  {:db/ident :fibo-be-ge-neuj/EstonianEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Estonian entity@en"
                #xsd/langString "Eesti üksus@et"],
...
(def FinnishEntity
  ...
  {:db/ident :fibo-be-ge-neuj/FinnishEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Suomen entiteetti@fi"
                #xsd/langString "Finnish entity@en"],
...
(def GovernmentOfAland
  ...
  {:cmns-av/explanatoryNote
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Ålands regering@sv"
                #xsd/langString "Ahvenanmaan hallitus@fi"
                #xsd/langString "Government of Aland@en"],
   :rdfs/seeAlso {:rdfa/uri
...
(def GovernmentOfIceland
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfIceland,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Ríkisstjórn Íslands@is"
                #xsd/langString "Government of Iceland@en"],
   :rdfs/seeAlso {:rdfa/uri "https://www.government.is/"},
   :skos/definition
   "unitary parliamentary republic and representative democracy, that is a Nordic island country in the North Atlantic"})
...
(def GovernmentOfTheKingdomOfDenmark
  ...
  {:cmns-av/synonym [#xsd/langString "Danish government@en"
                     #xsd/langString "Danmarks regering@da"],
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Government of the Kingdom of Denmark@en"
                #xsd/langString "Kongeriget Danmarks regering@da"],
   :rdfs/seeAlso
   {:rdfa/uri
...
(def GovernmentOfTheKingdomOfNorway
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheKingdomOfNorway,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Kongeriket Norges regjering@no"
                #xsd/langString "Government of the Kingdom of Norway@en"],
   :rdfs/seeAlso {:rdfa/uri
...
(def GovernmentOfTheKingdomOfSweden
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheKingdomOfSweden,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Konungariket Sveriges regering@sv"
                #xsd/langString "Government of the Kingdom of Sweden@en"],
   :rdfs/seeAlso {:rdfa/uri "https://www.government.se/government-of-sweden/"},
   :skos/definition
   "constitutional monarchy and parliamentary democracy, with a largely ceremonial and representative monarch as head of state, located in Scandinavia between the North Atlantic, the Baltic Sea and Eurasian Russia"})
...
(def GovernmentOfTheRepublicOfEstonia
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheRepublicOfEstonia,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Government of the Republic of Estonia@en"
                #xsd/langString "Eesti Vabariigi valitsus@et"],
   :rdfs/seeAlso {:rdfa/uri "https://www.valitsus.ee/en/"},
   :skos/definition
   "democratic unitary parliamentary republic divided into fifteen counties, located on the eastern coast of the Baltic Sea in Northern Europe"})
...
(def GovernmentOfTheRepublicOfFinland
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheRepublicOfFinland,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Suomen tasavallan hallitus@fi"
                #xsd/langString "Government of the Republic of Finland@en"],
   :rdfs/seeAlso {:rdfa/uri "https://valtioneuvosto.fi/en/government"},
   :skos/definition
   "parliamentary republic within the framework of a representative democracy comprised of 19 regions and 310 municipalities, located in the Nordic region of Europe"})
...
(def GovernmentOfTheRepublicOfIreland
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheRepublicOfIreland,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Rialtas Phoblacht na hÉireann@ga"
                #xsd/langString "Government of the Republic of Ireland@en"],
   :rdfs/seeAlso {:rdfa/uri "https://www.gov.ie/"},
   :skos/definition
   "parliamentary, representative democratic republic, based on the British model, that is an independent state and member of the European Union, which covers five-sixths of the island of Ireland in the North Atlantic"})
...
(def GovernmentOfTheRepublicOfLatvia
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheRepublicOfLatvia,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Latvijas Republikas valdība@lv"
                #xsd/langString "Government of the Republic of Latvia@en"],
   :rdfs/seeAlso {:rdfa/uri "https://www.mk.gov.lv/en"},
   :skos/definition
   "unitary, parliamentary, constitutional republic located in the Baltic region of Northern Europe"})
...
(def GovernmentOfTheRepublicOfLithuania
  ...
  {:db/ident :fibo-be-ge-neuj/GovernmentOfTheRepublicOfLithuania,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Lietuvos Respublikos Vyriausybė@lt"
                #xsd/langString "Government of the Republic of Lithuania@en"],
   :rdfs/seeAlso {:rdfa/uri "https://lrv.lt/en/"},
   :skos/definition
   "unitary semi-presidential republic situated along the southeastern shore of the Baltic Sea, to the southeast of Sweden and Denmark"})
...
(def IcelandicEntity
  ...
  {:db/ident :fibo-be-ge-neuj/IcelandicEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Íslensk eining@is"
                #xsd/langString "Icelandic entity@en"],
...
(def IrishEntity
  ...
  {:db/ident :fibo-be-ge-neuj/IrishEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Irish entity@en"
                #xsd/langString "Aonán Éireannach@ga"],
...
(def JurisdictionOfDenmark
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfDenmark,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Denmark@en"
                #xsd/langString "Danmarks jurisdiktion@da"],
   :rdfs/seeAlso {:rdfa/uri "https://en.wikipedia.org/wiki/Courts_of_Denmark/"},
   :skos/definition
   "jurisdiction of the judiciary of Denmark, a civil law system with some references to Germanic law that was substantially reformed in 2007"})
...
(def JurisdictionOfEstonia
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfEstonia,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Estonia@en"
                #xsd/langString "Eesti jurisdiktsioon@et"],
   :rdfs/seeAlso
   {:rdfa/uri "https://www.kohus.ee/en/estonian-courts/estonian-court-system"},
   :skos/definition
   "jurisdiction of the judiciary of Estonia, a civil law legal system based on the Germanic legal model, whose Supreme Court is the court of cassation, which also conducts constitutional review"})
...
(def JurisdictionOfFinland
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfFinland,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Finland@en"
                #xsd/langString "Suomen lainkäyttövaltaan@fi"],
   :rdfs/seeAlso {:rdfa/uri
...
(def JurisdictionOfIceland
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfIceland,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "lögsögu Íslands@is"
                #xsd/langString "jurisdiction of Iceland@en"],
   :rdfs/seeAlso
   {:rdfa/uri
...
(def JurisdictionOfIreland
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfIreland,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Ireland@en"
                #xsd/langString "dlínse na hÉireann@ga"],
   :rdfs/seeAlso
   {:rdfa/uri "https://www.citizensinformation.ie/en/justice/courts_system/"},
   :skos/definition
   "jurisdiction of the judiciary of Ireland, which is the system of courts that interprets and applies the law in Ireland"})
...
(def JurisdictionOfLatvia
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfLatvia,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Latvia@en"
                #xsd/langString "Latvijas jurisdikcija@lv"],
   :rdfs/seeAlso {:rdfa/uri "http://www.satv.tiesa.gov.lv/"},
   :skos/definition
   "jurisdiction of the judiciary of Latvia, which is the system of courts that interprets and applies the law in Latvia"})
...
(def JurisdictionOfLithuania
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfLithuania,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Lithuania@en"
                #xsd/langString "Lietuvos jurisdikcija@lt"],
   :rdfs/seeAlso {:rdfa/uri
...
(def JurisdictionOfNorway
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfNorway,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiksjon av Norge@no"
                #xsd/langString "jurisdiction of Norway@en"],
   :rdfs/seeAlso {:rdfa/uri "https://www.domstol.no/en/"},
   :skos/definition
   "jurisdiction of the judiciary system in Norway, a civil law system where laws are created and amended in parliament and the system regulated through the Courts of Justice of Norway"})
...
(def JurisdictionOfSweden
  ...
  {:db/ident :fibo-be-ge-neuj/JurisdictionOfSweden,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "jurisdiction of Sweden@en"
                #xsd/langString "Sveriges jurisdiktion@sv"],
   :rdfs/seeAlso
   {:rdfa/uri
...
(def LatvianEntity
  ...
  {:db/ident :fibo-be-ge-neuj/LatvianEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Latvijas vienība@lv"
                #xsd/langString "Latvian entity@en"],
...
(def LithuanianEntity
  ...
  {:db/ident :fibo-be-ge-neuj/LithuanianEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Lithuanian entity@en"
                #xsd/langString "Lietuvos subjektas@lt"],
...
(def NorwegianEntity
  ...
  {:db/ident :fibo-be-ge-neuj/NorwegianEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Norwegian entity@en"
                #xsd/langString "Norsk enhet@no"],
...
(def SwedishEntity
  ...
  {:db/ident :fibo-be-ge-neuj/SwedishEntity,
   ...
   {:rdfa/uri
    "https://spec.edmcouncil.org/fibo/ontology/BE/GovernmentEntities/EuropeanJurisdiction/NorthernEuropeGovernmentEntitiesAndJurisdictions/"},
   :rdfs/label [#xsd/langString "Swedish entity@en"
                #xsd/langString "Svensk enhet@sv"],
